...
namespace SimplifiedChineseLanguagePack
{
    ...
    public class SimplifiedChineseLanguagePackPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            NevernamedsSigilariumMod.RegisterTranslations();
            AllTheSigilsMod.RegisterTranslations();
            BittysSigilsMod.RegisterTranslations();
            BittysChallengesMod.RegisterTranslations();
            P03SigilariumMod.RegisterTranslations();
            P03InKayceesModMod.RegisterTranslations();
            P03ExpansionPack3Mod.RegisterTranslations();
            PeltsOnlyMod.RegisterTranslations();
            DeathcardChallengesMod.RegisterTranslations();
            PermaDeathMod.RegisterTranslations();
            KCMHammerMod.RegisterTranslations();
            BetterTotemsMod.RegisterTranslations();
            EyeAndDaggerMod.RegisterTranslations();
            LesserSideDeckMod.RegisterTranslations();
            CursesMod.RegisterTranslations();
            EndlessAct2Mod.RegisterTranslations();
        }
        ...
        private static void PostRegisterTranslations()
        {
            ...
            foreach (var value in CardManager.BaseGameCards)
            {
                ...
                {
                    LocalizationManager.Translate(GUID, null, "You need two " + HintsHandler.GetColorCodeForGem(gemType) + gemTypes[gemType] + " </color> gems to play that " + value.DisplayedNameLocalized, "需要两颗" + HintsHandler.GetColorCodeForGem(gemType) + gemTypes[gemType] + "</color>宝石才能使用这张" + value.DisplayedNameLocalized, Language.ChineseSimplified);
                }
                LocalizationManager.Translate(GUID, null, "Your [c:bR]" + value.displayedName + "[c:] seems empowered by your sacrifice.", "你的[c:bR]" + value.DisplayedNameLocalized + "[c:]因献祭而强化了。", Language.ChineseSimplified);
                LocalizationManager.Translate(GUID, null, "Your " + value.displayedName + " was empowered!", "你的" + value.DisplayedNameLocalized + "被强化了！", Language.ChineseSimplified);
                LocalizationManager.Translate(GUID, null, "Your [c:bR]" + value.displayedName + "[c:] seems bolstered by your sacrifice.", "你的[c:bR]" + value.DisplayedNameLocalized + "[c:]因献祭而被巩固了。", Language.ChineseSimplified);
                LocalizationManager.Translate(GUID, null, "Your " + value.displayedName + " was bolstered!", "你的" + value.DisplayedNameLocalized + "被巩固了！", Language.ChineseSimplified);
                LocalizationManager.Translate(GUID, null, "You don't have enough gems to play that " + value.DisplayedNameLocalized + "!", "你的宝石不足，无法使用这张" + value.DisplayedNameLocalized + "！", Language.ChineseSimplified);
            }
            foreach (var value in newCards)
            {
                foreach (var gemType in gemTypes.Keys)
    ...
    public class APIMod
    {
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Incompatible with: 饥荒", "不兼容挑战：饥荒", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Incompatible with: 五谷丰登", "不兼容挑战：五谷丰登", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Incompatible with: 天平不平", "不兼容挑战：天平不平", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Incompatible with: 反向天平不平", "不兼容挑战：反向天平不平", Language.ChineseSimplified);
            //LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Depends on: ", "依赖于挑战：", Language.ChineseSimplified);
    ...
    public class GrimoraMod
    {
        ...
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil gains 1 attack for each bone the player currently has.", "[creature]会根据玩家当前拥有的骨头数量获得等量攻击力，每根骨头增加1点攻击力。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil has 10 attack, 1 for each Candy Bucket Sawyer has left.", "[creature]拥有10点力量，索耶每剩余1个糖果桶便增加1点力量。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil gains 1 attack for every pirate on the board.", "[creature]会根据场上每名海盗增加1点攻击力。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil gains 1 attack for every card that has 0 attack on the board.", "牌桌上每存在一张0点攻击力的卡牌，[creature]就会获得1点攻击力。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spirit Bearer", "灵魂商", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "CRUSHED BY THE ROOF OF HIS OWN HOUSE. LIVING ON AS A PILE OF GOO.", "被自家屋顶压碎。化作一滩黏液苟活。", Language.ChineseSimplified);
    ...
    public class MagnificusMod
    {
        ...
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, select a mox type for this card to provide.", "当[creature]打出时，选择一种玛珂类型供其提供。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, it creates a Ruby Mox in its place.", "[creature]阵亡时，会在原地生成一张红宝石玛珂。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, it creates a Sapphire Mox in its place.", "[creature]阵亡时，会在原地生成一个蓝宝石玛珂。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When one of your non-gem cards perishes, a card bearing this sigil gains 1 power, maxing out at 5.", "当你的非宝石卡牌阵亡时，[creature]获得1点力量，最高可叠加至5点。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of every turn, a card bearing this sigil gains 1 power, maxing out at 4.", "每回合结束时，[creature]增加1点力量，最高不超过4点。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of every turn, a card bearing this sigil gains 2 health, maxes out at 10.", "每回合结束时，[creature]获得2点生命值，上限为10点。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, it creates an Emerald Mox in its place.", "[creature]阵亡时，会在原地生成一张绿宝石玛珂。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is struck, the striker loses 1 attack.", "[creature]受到攻击时，攻击者失去1点力量。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, draw cards from your deck based on how many Gems are on the board.", "当使用[creature]时，根据牌桌上宝石数量从牌组抽取相应数量的卡牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil deals direct damage, draw cards from your deck based on how much damage was dealt.", "当[creature]造成直接伤害时，根据造成的伤害数值从牌组抽取相应数量的牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil deals direct damage, the amount dealt will be healed to the owner of this card.", "当[creature]造成直接伤害时，伤害值将转化为持牌人的生命恢复。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil hits an opposing card, the opposing card will be kicked in the direction inscrybed in the sigil.", "[creature]击中对手卡牌时，会将对手卡牌朝印记所示方向击退。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, it creates a Spear in its placed. A spear is defined as Sharp, 0 power, 3 health.", "[creature]阵亡时，会在其位置生成一柄长矛。长矛具有：0点力量，3点生命，尖刺铠甲。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While a card bearing this sigil is on the board, it provides an orange gem, a blue gem and a green gem to its owner.", "当牌桌上有[creature]时，可为持牌人提供橙、蓝、绿三色玛珂各一颗。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of every turn, a card bearing this sigils' base power will be increased by a random value between 0 and 3.", "每回合结束时，[creature]基础力量会变成0至3的随机数。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, the opposing card also perishes.", "[creature]阵亡时，对面的卡牌也会同时阵亡。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, all gems on the board gain a shield.", "使用[creature]时，牌桌上所有宝石均获得护盾。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While a card bearing this sigil is on the board, all gems on your side of the board gain the Sharp Quills sigil, and 2 health.", "当[creature]在场时，持牌人侧牌桌上所有宝石获得尖刺铠甲印记和2点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Animator", "操偶师", Language.ChineseSimplified);
            RegisterAbility("Animator", "操偶师");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While a card bearing this sigil is on the board, all non-mox cards with 0 power gain 2 power", "当[creature]在场时，所有力量为0的非玛珂卡牌获得2点力量。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, all gems on your side of the board will perish. For each gem absorbed, gain 1 power and 2 health.", "当[creature]使用时，持牌人侧牌桌上的所有宝石将被摧毁。每吸收一个宝石，获得1点力量和2点生命。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the turn, a card bearing this sigil will submerge. Upon resubmerging, this card will become a random Tentacle Card.", "回合结束时，[creature]会下潜。重新上浮时，该卡牌会变为随机触手卡牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil will perish if there are no non-gem cards on the board.", "若牌桌上没有非宝石卡牌，[creature]将会阵亡。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A card bearing this sigil will perish at the end of the turn.", "[creature]会在回合结束时消亡。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, it will mimic the card opposing it. If there is no card opposing it, this card will perish.", "当[creature]被使用时，会复制对面位置的卡牌。若对面无卡牌，则该卡牌会死亡。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, draw another of this card, but with a different gem cost.", "使用[creature]时，抽一张同名卡牌，但其宝石需求会发生变化。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, every empty opposing slot will be filled with flames. A flame is defined as a 0/1, Annoying.", "当[creature]被使用时，所有对侧空位将被火焰填满。火焰具有：0点力量，1点生命值，惹人生厌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is stuck, it will move and leave behind an astral projection of itself.", "[creature]受击时会移动，并留下自身的星体投影。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, draw a random spell card.", "[creature]打出时，随机抽取一张法术牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, draw a random one of Bleene's Books.", "[creature]打出时，随机抽取一本蓝绿橙大师的书。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil attacks another card, the attacked card will lose all of it's attack and turn to gold.", "[creature]攻击其他卡牌时，被攻击的卡牌将失去所有力量并转化为黄金。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil perishes, the killer will gain 2 crystals.", "[creature]阵亡时，击杀者将获得2颗水晶。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, it will summon two runes beside it. A rune is defined as 0 power, 1 health, Detonator.", "当[creature]被使用时，会在其相邻位置召唤两个魔法炸弹符文。符文具有：0点力量、1点生命，引爆器。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is played, all cards on the board will move clockwise.", "当[creature]被使用时，牌桌上所有卡牌均会按顺时针方向移动。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigils attack another card, that card will lose 1 attack.", "[creature]攻击其他卡牌时，被攻击卡牌会失去1点力量。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card bearing this sigil is drawn, another of this card will be added randomly into your deck", "抽到[creature]时，会随机将一张同名卡牌加入你的牌组。", Language.ChineseSimplified);
            ...
            foreach (Ability ability in Enum.GetValues(typeof(Ability)))
            {
                ...
                {
                    Debug.LogWarning($"Ability {ability} 没有有效的info，已跳过。");
                    continue;
                }
                if (info.rulebookName == null || Abilities.ContainsKey(info.rulebookName))
                {
                    Debug.LogWarning($"Ability {ability} 没有有效的rulebookName，或本身已注册，已跳过。");
                    continue;
                }
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Maux", "王马王可", Language.ChineseSimplified);
            RegisterCard("Maux", "王马王可", "In all my years, I have NEVER seen an imitation cruder than this.", "老夫平生从未见过如此拙劣的仿品");
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm, a cursed skull. Handle it with care.", "唔，一个被诅咒的头骨。务必小心处理。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Inspiration", "灵感", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm.. That's not how it works here, challenger..", "唔……这里的规则可非如此，挑战者……", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:g3]Hmm..?[c:] [c:g1]Another[c:] [c:g3]student[c:] [c:g1]here?[c:]", "[c:g3]唔…？[c:][c:g1]又来[c:][c:g3]一个[c:][c:g1]学徒？[c:]", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:g3]Hmm..[c:] [c:g1]I[c:] [c:g3]think[c:] [c:g1]it's[c:] [c:g3]time[c:] [c:g1]to[c:] [c:g3]play[c:] [c:g1]some[c:] [c:g3]more...[c:]  [c:g2]forbidden[c:] [c:g1]books[c:]", "[c:g3]唔……[c:][c:g1]是时候[c:][c:g3]再[c:][c:g1]玩些……[c:][c:g3]禁书[c:][c:g1]了[c:]", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm.. Something feels off..", "唔…有些不对劲……", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm.. The essence of that sigil does not resonate with your card..", "唔……该印记的精髓与你的卡牌并不契合……", Language.ChineseSimplified);
    ...
    public class UndeadTempleINKCMMod
    {
        ...
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The corpse of a stiff terrestrial creation.", "僵硬的陆地造物的尸体。", Language.ChineseSimplified);
    ...
    public class WildernessLegendMod
    {
        ...
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Any creature that dreams of harming it will regret it.", "任何想伤害它的造物都会后悔的。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A peculiar creature that only exists in nightmares.", "一种只存在于噩梦中的奇特造物。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A terrifying creature from the world of Minecraft.", "我的世界里的可怕造物。", Language.ChineseSimplified);
    ...
    public class PackManagementMod
    {
        ...
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A large expansion containing [count] creatures from Hollow Knight. Up from peaceful Crossroads, down into the Abyss.", "大型扩展包，内含[count]种来自《空洞骑士》的造物。从宁静的十字路，下至深渊之底。", Language.ChineseSimplified); // todo
            RegisterEncounter("Hallownest Expansion", "圣巢扩展包", "A large expansion containing [count] creatures from Hollow Knight. Up from peaceful Crossroads, down into the Abyss.", "大型扩展包，内含[count]种来自《空洞骑士》的造物。从宁静的十字路，下至深渊之底。");
    ...
    public class NevernamedsSigilariumMod
    {
        public static void RegisterTranslations()
        {
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shield Generator", "护盾生成器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wiseclock", "时针顺", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mrs Bombs Remote", "炸弹夫人的遥控器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hourglass", "沙漏", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Magpies Glass", "喜鹊的放大镜", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Web", "网", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Zap", "电击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dead ", "死亡", Language.ChineseSimplified);
            ...
            // Opponent
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shadowy Figure", "朦胧的身影", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bloodbait", "血之饵", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Strike", "骨驱打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Carnivore", "食肉动物", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Causality", "因果关系", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 1 currency to trigger a random effect.", "消耗1点货币触发随机效果：无效果、直接对对手造成 1 点伤害、使你一张卡牌的攻击力增加 1，或使你一张卡牌的生命值增加 1。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deadbeat", "精力费尽", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dredge", "疏浚囤积", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exalted Rune", "崇高古文", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fetch", "骨驱冲刺", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flip", "赌博按钮", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Remove", "移除按钮", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Aculeate Grip", "蛰刺握", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Allure", "媚骨天生", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ant Guardian", "蚂蚁守护者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Antimagic", "反魔法", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Armortify", "装甲化", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Artistic License", "艺术许可", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Backup", "数据备份", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bandage Weaver", "绷带编织者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bewilder", "扑朔迷离", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bifurcated When Gempowered", "橙色兵分", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bisection", "二分法", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bloated", "肥美多汁", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Artist", "血液艺术家", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Dependent", "血液依赖", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You may sacrifice terrain cards in order to play [creature].", "你可以献祭地形卡来打出[creature]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Gusher", "鲜血喷涌", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bloodrunner", "血行者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blue Inspiration", "蓝色灵感", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Duke", "骨公爵", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Buzz Off", "蜉蝣冲击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Call To Arms", "号召行动", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Card Shedder", "牌堆剥离者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Caustic", "物腐毒生", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cheater", "欺诈者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Circuit Maker", "电路绘制", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Claw", "利爪", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will lose all attack power if it is not directly adjacent to a card bearing the clawed sigil.", "若[creature]未与带有利喙尖爪印记的卡牌直接相邻，将失去所有攻击力。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Clawed", "利喙尖爪", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cleaving", "劈裂", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Omnipotent When Powered", "充能全向打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Powered Quills", "充能双重刺甲", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Print When Powered", "充能玛珂绘制", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Repulsive When Powered", "充能厌恶情绪", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Billowing Bond", "空袭契约", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Elder Conduit", "宝石骷髅管道", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Friendship Bond", "友谊契约", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Grave Conduit", "掘骨管道", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gun Conduit", "哨兵管道", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Loot Conduit", "劫掠管道", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Meaningless Bond", "空无契约", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tender Bond", "温柔契约", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Confusion", "颠三倒四", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Copier", "影印设备", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Coward", "贪生怕死", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Crossbones", "十字骨", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deadringer", "死铃使者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Death Snatch", "死亡掠夺", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Defiler", "污染者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Desperate", "孤注一掷", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deus Hoof", "鹿神敬拜", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dexter Strike", "右前打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Diagonal Strike", "对角打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Distraction", "魂不守舍", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Diver", "潜行者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] can strike the opposing card even while it is submerged.", "[creature]可以直接攻击对位处于水袭状态的卡牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Divisibility Strike", "可除性打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Doomed", "命中注定", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Double Tap", "协同攻击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw", "绘牌之手", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dripping", "流连", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Drop", "得手投弃", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Duppelgang", "双重奏", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eager", "渴望", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Easy Pickings", "轻而易举", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emancipation", "脱胎换骨", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emerald Core", "绿宝石核芯", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Enemy Lines", "敌军战线", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Enraged", "愤怒", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Entangle", "盘根错节", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exceptional Sacrifice", "传说祭品", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bloodstarved Beast", "嗜血狂兽", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Expulsion", "呕物驱逐", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exsanguination", "放血", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eye For Battle", "战斗之眼", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fan Tailed", "妖扇之尾", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fearsome", "凶神恶煞", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "File Explorer", "文件管理", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Filter Feeder", "滤食之物", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Firebomb", "火焰引爆器", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fire In The Hole", "小心炮弹", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fire Resistant", "防火", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flank Blast", "侧牌引爆器", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flea Ridden", "跳蚤满身", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes to combat, it creates a Flea in all empty adjacent slots. A Flea is defined as 0 Power, 1 Health, Eager, Frail", "[creature]在战斗中阵亡时，会在所有相邻空位生成跳蚤。跳蚤具有：0点力量、1点生命，渴望，脆弱。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flighty", "轻浮", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, all airborne creatures require exactly 1 less of their respective cost to be played.", "当[creature]在牌桌上时，所有具有空袭印记的召唤需求减少1点对应资源。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Friend Finder", "找呀找朋友", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random friend is created in the slots to it's left and right.", "使用[creature]时，其左右两侧空位将各生成一个随机Steam好友。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fringe Strike", "边路打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Frog Friend", "众蛙之友", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Globetrotter", "四海为家", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Green Inspiration", "绿色灵感", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gut Spewer", "呕脏者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Healshield", "治疗护盾", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Herald", "使节", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "High Powered", "高功率", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Home Run", "全垒打", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hypermorphic", "超形态", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ignition", "点燃", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Immaterial", "缥缈之物", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] would be struck, a mess is created in its place and a card bearing this sigil moves to the right.", "当[creature]即将受到攻击时，会在其位置生成一团污秽，同时[creature]会向右移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Inspiring Sacrifice", "鼓舞之血", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Instant Effect", "即时效果", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Killing Joke", "杀戮玩笑", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Kindred", "亲族之后", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "L33p Leaver", "跳跃机器人掉落器", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Landscaper", "景观设计师", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Burning Latch", "燃焰传花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Burrower Latch", "钻地龙传花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Frail Latch", "脆弱传花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Null Latch", "空无传花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lockdown", "锁关闭隘", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lurk", "水袭哨兵", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Marcescent", "凋而不落", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mauler", "抨击者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Medicinal", "灵丹妙药", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mockery", "嘲弄", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Morph Mover", "无形移态", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Motivator", "斗志之源", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Moxcraft", "玛的世界", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mox Max", "玛珂最大值", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Moxwarp", "变形玛珂", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Nature Of The Beast", "野性呼唤", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Obedient", "悉听尊便", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Crusher", "碎石者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deerly Departed", "屠鹿者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dog Gone", "猎犬者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fowl Play", "戏鸟者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Insectivore", "食虫者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Snakebite", "捕蛇者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Orange Inspiration", "橙色灵感", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Organ Thief", "器官盗贼", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Painful Presence", "痛苦占场", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Phantasmic", "移形换影", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Point Nemo", "涨潮者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Potent", "强力献祭", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Preemptive Strike", "预先攻击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Propagation", "传播者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Prophecy", "预言家", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmmm... your new prophecy overwrites the old, it would seem.", "唔...看来你的新预言覆盖了旧的。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm... very well", "唔...很好", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Put Sentry Here", "步哨工程师", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Quickdraw", "即刻抽取", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ranger", "突击员", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ravenous", "贪婪之噬", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Recharge", "养精蓄锐", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Recycle", "回收利用", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Reflective", "镜面反击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Regenerator", "万象更新", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rememberance", "纪念之花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Reroute", "重新定向", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Resilient", "百折不挠", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Retreat", "退却", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Return Strike", "复仇攻击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Revolve", "时针顺之魂", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rock Eater", "磐石吞噬者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ruby Core", "红宝石核芯", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rupture", "割裂之触", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sanguine", "血祭力量", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sapphire Core", "蓝宝石核芯", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sharp Bones", "骨骼刺甲", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sharp Shot", "致命触击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sigil Mimic", "印记模仿", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skin Animator", "毛皮操偶师", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skull Swarm", "骷髅双击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Snare", "恶食陷阱", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Snip", "剪刀之魂", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Soak", "浸微浸消", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spiders Web", "蛛猎之网", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Split Detonation", "对角引爆器", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spurred", "驱使者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sticky Trail", "黏性痕迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] enters a space on the board, it permantently marks that space with its slime. Any creatures that enter that space without the Made of Stone sigil lose 1 power.", "当[creature]进入牌桌某位置时，会永久用黏液标记该处。任何进入该位置且不具有磐石之身印记的造物将失去1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sturdy", "坚不可摧", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Subaquatic Spines", "水下刺", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Surging Quills", "激流刺甲", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sweeping Strike Left", "横扫左击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sweeping Strike Right", "横扫右击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Switch Strike", "交替打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Swooping Strike", "翻飞打击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tempting Target", "诱人的目标", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Termatriarch", "白蚁后", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] and a different card bearing the Termatriarch sigil are alive and on the board, a termite will be created in your hand at the start of your turn.", "当[creature]与另一张带有白蚁后印记的卡牌存活于场上时，你的回合开始时将获得一张白蚁卡牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Thief", "盗贼", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trajectile Quills", "狙击刺甲", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trampler", "撼地者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trifling Sacrifice", "精良祭品", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trio", "禁忌三重奏", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tuck And Roll", "缩滚乐", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of combat, [creature] will move to the free space opposed by the least amount of attack power, taking into account queued creatures, flight, and Touch of Death.", "战斗结束时，[creature]会移动到受攻击力最小的空闲位置，计算时考虑后排待命造物、飞行与死神之触。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tug", "生拉硬拽", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Twin Bond", "双生契约", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Twister", "星轮变换", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Unhammerable", "不可锤击", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Unlucky", "命途多舛", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Unspeakable", "不可言喻", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Valuable", "吉光片羽", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Vampiric", "吸血鬼", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Venator", "易形猎手", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Visceral", "感官异能", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weaver", "织网者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weird Latch", "无形传花", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wild Shape", "狂野易形", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wing Clipper", "碎翼者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wingrider", "骑翼者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Woodsie Lord", "法树领主", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, Enchanted Pines are created on every empty space. An enchanted pine is defined as 0 power, 3 health.", "使用[creature]时，所有空位将生成附魔松树。附魔松树具有：0点力量、3点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wriggle", "蠕形螨动", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Writhe", "垂死挣扎", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ambitious", "野心家", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ant Plus Two", "#蚂蚁+2", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Birds of a Feather", "鸟为媒", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Boned", "不变之骨", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Crab Dance", "螃蟹舞", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Director Of The Board", "董事长", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Drawn Out", "抽离之力", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fabled", "稀有传奇", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Firepower", "火焰之力", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Follow The Leader", "跟随领导", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hand On Heart", "手按心", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Herding Beast", "放牧兽", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lithophile", "亲石者", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Magicke Power", "魔法力量", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The value represented with this sigil is equal to the number of sigils this card has removed with the Bleach Sigil or Artistic License Sigil.", "该印记代表的数值等于该卡牌通过漂白剂印记或艺术许可印记移除的印记数量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature]s power is equal to the number of sigils it has removed with the Bleach Sigil or Artistic License Sigil.", "[creature]的力量等于其通过漂白剂印记或艺术许可印记移除的印记数量。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pack Hunter", "犬之猎", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pack Power", "道具力量", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pack Power Plus", "双重道具力量", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sanguine Bond", "狂热血祭", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The value represented with this sigil will be equal to the amount of sigils present on the creatures that were sacrificed to play it's bearer.", "该印记代表的数值等于召唤该造物时被献祭造物携带的印记总数。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature]s power is equal to the amount of sigils present on the creatures that were sacrificed to play it.", "[creature]的力量等于召唤该造物时被献祭造物携带的印记总数。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Starved", "饥渴", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trinket Vitality", "道具生命力", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Abstain", "忍住", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dupeglitch", "丰产囤积狂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sinister Strike", "左前打击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bully", "横行霸道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Legion", "集团", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bloodborn", "血魔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Divination", "占星师", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exhume", "寻墓者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eternal", "天使坠落", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Goated", "山羊召唤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Healer", "治疗师", Language.ChineseSimplified);
        }
    }
    public class AllTheSigilsMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for AllTheSigils Mod");
            // Card
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Acid Puddle", "酸液滩", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A puddle of Acid, dangerous to the touch", "一滩酸液，摸起来很危险。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Jackalope", "鹿角兔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Jacka", "杰卡", Language.ChineseSimplified);

            // Ability
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Abundance", "五谷丰登", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will grant one tooth per instance of Abundance when killed.", "[creature]死亡时，每有一个五谷丰登的实例，就会获得一个货币。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Acidic Trail", "酸性痕迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil, and deal 1 damage to the opposing creature if it is able to move.", "在持牌人回合结束时，[creature]将沿印记标注的方向移动，如果能够移动，则对其对位造物造成1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Activated Latch Brittle", "脆骨激转", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When activated for a cost of 1 energy will allow the owner to give a creature Brittle.", "激活时消耗1点能量，将允许持牌人给予一个造物脆骨印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Activated Latch Explode On Death", "炸弹激转", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When activated for a cost of 1 energy will allow the owner to give a creature Explode On Death.", "激活时消耗1点能量，将允许持牌人给予一个造物引爆器印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Activated Latch Nano Shield", "坚盾激转", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When activated for a cost of 1 energy / 2 bones will allow the owner to give a creature Nano Shield.", "激活时消耗1点能量/2根骨头，将允许持牌人给予一个造物纳米铠甲。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Activated Latch Reach", "高跳激转", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When activated for a cost of 2 energy will allow the owner to give a creature Reach.", "激活时消耗2点能量，将允许持牌人给予一个造物高跳印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Agile", "敏捷", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] would be struck, it will move out of the way.", "当[creature]将被击中时，它会跳开躲避。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Card jumped out of the way to save itself...", "这张牌为了保全自己而跳到一边...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The trail they leave behind, hurts.", "他们留下的痕迹让人生疼。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "All seeing", "全知之眼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, all talking cards on your side of the board get +2 health.", "当[creature]在场时，同侧场上的所有会说话的卡牌获得+2生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Alternating Scratch", "交替爪迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] attacks it will also attack a space adjacent to the attacked slot, the adjacent slot that it will attack will change between left or right at the end of each opponent's turn.", "当[creature]攻击时，它还会攻击对位相邻的空间，它将攻击的相邻位置将在每个对手回合结束时在左右之间切换。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ambush", "伏击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a creature moves into the space opposing [creature], they are dealt 1 damage.", "当造物移动到与[creature]相对的空间时，它们会受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Antler Bearer", "鹿角商", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is killed, gain three random hooved tribe cards.", "当[creature]被消灭时，随机获得三张随机有蹄部落卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The herd sticks together.", "牧群聚在一起。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shielded", "屏蔽", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is dealt damage, the damage dealt is halved, rounded down.", "当[creature]受到伤害时，造成的伤害减半，向下取整。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Asleep", "休眠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] has 0 attack for as long as it has this sigil, at the start of the player's turn this sigil will be removed from [creature].", "[creature]只要拥有此印记，攻击力为0，玩家回合开始时，此印记将从[creature]上移除。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bait", "钓饵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When an opposing creature is played and there is no card opposite of [creature], the opposing creature will move to that spot.", "当对侧上场卡牌时，若没有与[creature]相对位的卡牌，该造物将移动到[creature]的对位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Noble Sacrifice", "卓越祭品", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is counted as 2 blood rather than 1 blood when sacrificed.", "[creature]被献祭时被计为2点血量而非1点（此印记对不可献祭的卡牌无效）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blight", "枯萎之血", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is sacrificed, it subtracts its stat values to the card it was sacrificed for.", "当[creature]被献祭时，献祭其上场的卡牌减去其属性值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Random Strike", "随机打击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will strike at opponent slots randomly when it attacks.", "[creature]攻击时会随机打击对手槽位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blinding Strike", "致盲打击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature gains the Random Strikes Sigil.", "当[creature]对另一造物造成伤害时，该造物获得随机打击印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They strike widly...", "它们的攻击如此..宽广...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Growth", "血液生长", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] attacks, the amount of blood it is counted as when sacrificed will increase.", "当[creature]攻击时，其作为祭品时计算的血量将会增加。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "There is power in the blood.", "血液中蕴含力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "BloodGuzzler", "鲜血吞噬者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] deals damage, it gains 1 Health for each damage dealt.", "[creature]造成伤害时，每造成1点伤害便获得1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gain life from the blood.", "从血中获得生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood shifter", "嗜血易形", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] kills another card, it will turn into that card.", "当[creature]杀死另一张牌时，它将变成那张牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bodyguard", "保镖", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will redirect the initial attack of a card to it, if the attack was targeting a card in an adjacent space.", "如果相邻的位置将受到攻击，攻击者会改为攻击[creature]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A protector, till the very end.", "一位致死也要坚持守护的保镖。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bombardier", "随机投弹手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will deal 10 damage to a random creature during the end phase of the owner's turn.", "[creature]将在每个持牌人的回合结束阶段对场上任何一个随机造物造成10点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bond", "情同手足", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Any creatures adjacent to [creature] will gain either +1 attack or +1 health, depending on which stat it is closest to.", "当[creature]左侧有卡牌时，[creature]将增加1点力量；当[creature]右侧有卡牌时，[creature]将增加1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] gives no bones! Any bones gained from sigils or death will be negated.", "[creature]死亡时没有骨头，所有印记给予的额外骨头将不生效。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That creature has no bones!", "这个造物没有骨头！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Picker", "衔骨者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] kills a creature, it will generate 1 Bone.", "[creature]每杀死一个造物，将生成1根骨头。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Shard", "骨头碎片", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will generate 1 bone when hit, if it lives through the attack.", "[creature]被击中时，如果存活下来，将给予持有者1根骨头。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A splinter of bone.", "一块骨头的碎片。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Box", "盒中之物", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will get removed from your deck on death, and a new creature contained within will be added to it.", "[creature]死亡时将从你的牌组中移除，并在你的卡组中添加一个包含其中的新造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Broken", "破碎", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is permanently removed from your deck if it dies.", "[creature]死亡后将永久从你的牌组中移除。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is on fire, and will gain 1 power and loose 1 health each upkeep. Blocked by Fire Resistance.", "[creature]在燃烧，并在每个回合结束时获得1点力量并失去1点生命值。可由防火免疫。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It rampages while on fire.", "它在燃烧时狂暴。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the towner's turn, [creature] will move in the direction inscribed in the sigil, and drop an acid puddle in their old space.", "在其持有者的回合结束时，[creature]将朝着印记标注的方向移动，并在其原位置留下一个酸液滩。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] counts as a Chicken.", "[creature]被计为一只鸡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Choreography", "舞蹈编排", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "On activation [creature] will cycle through: don't move, move left and move right. At the end of the owner's turn [creature] will move in the chosen way.", "激活后，[creature]将循环：不动、向左移动和向右移动。在持牌人回合结束时，[creature]将按照选择的方式移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Coin Finder", "硬币寻找者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will grant the owner 1 foil.", "在持牌人的回合结束时，[creature]将赋予其1枚硬币。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A tooth for your thoughts?", "这颗牙齿是你的意愿吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Consumer", "消费者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] kills another creature, it gains 2 health.", "当[creature]击杀其他造物时，它获得2点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cowardly", "懦夫", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will not attack a card with a power 2 higher than its own.", "[creature]不会攻击比自身攻击力高2的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deadly Waters", "死亡水域", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will kill cards that attacked over it while it was face-down. Does not affect cards that have Airborne or Made of Stone.", "[creature]在它潜水时，会消灭攻击过它位置的卡牌。不影响拥有空袭和磐石之身的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deathburst", "死亡爆发", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will deal 1 damage to each oppsing space to the left, right, and center of it.", "[creature]在死亡时会对其左侧、右侧和自身的每个敌对空间造成1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the Start of its owner's turn [creature] will lose -1 attack and will gain +1 health.", "在持牌人的回合开始时，[creature]将失去1点攻击力并获得1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Desperation", "绝望之力", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is damaged to 1 health, it will gain 3 power.", "[creature]受伤至只有1点生命时，其获得3点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When so close to death, it strikes out.", "当离死亡如此之近的时候，它爆发了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Disease Absorbtion", "疫病汲取", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When played, [creature] will take all negative sigils onto itself.", "当[creature]上场时，其会将场上所有负面印记转移到自身。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "How Noble.", "多么高尚。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dive (Bones)", "骨驱水袭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 bones to cause this card to flip face down at the end of the owner's turn.", "支付两根骨头，持牌人的回合结束时，[creature]将潜水一回合（重复点击没有效果，除非你想浪费骨头）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dive (Energy)", "电驱水袭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 energy to cause this card to flip face down at the end of the owner's turn.", "支付两点能量，持牌人的回合结束时，[creature]将潜水一回合（重复点击没有效果，除非你想浪费能量）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Multi-Strike", "多重打击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will strike a card multiple times, if it lives through the first attack. Will not trigger -on attack- or -on damage- effects with the extra strikes.", "如果[creature]攻击的目标在其第一次攻击下存活，其将会多次打击该牌。不会触发额外打击的攻击或受伤的触发器效果。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Double scratch", "", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Double scratch", "双重爪迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] attacks it attacks twice and the space right and left of the attacked slot.", "当[creature]攻击时，它会攻击两次，并攻击对位的左右两侧的空间。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Blood", "血绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random card costing blood is created in your hand.", "当[creature]被召唤时，你的手牌中会随机创建一张消耗血液的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Bone", "骨绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random card costing bone is created in your hand.", "当[creature]被召唤时，你的手牌中会随机创建一张消耗骨头的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Card", "冰绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a card relating to it's ice cube parameter (default Stoat) is created in your hand.", "当[creature]被召唤时，会根据其冰立方参数（默认为白鼬）在你的手中创建一张相关卡片。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Jackalope", "鹿角兔子洞", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a Jackalope is created in your hand.", "当[creature]被召唤时，你会获得一张鹿角兔卡牌，鹿角兔具有：2点力量，2点生命，冲刺能手，鹿角兔子洞。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Strafe", "冲刺绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] moves, a random card with a movement sigil is created in your hand.", "当[creature]移动时，会在你的手中随机创建一张带有移动印记的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Cost", "花费绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random card that has the same cost type as [creature] is created in your hand.", "当[creature]被召唤时，你的手牌中将随机生成一张与[creature]相同费用类型的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Energy", "能量绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random card costing energy is created in your hand.", "当[creature]被召唤时，会在你的手中随机创建一张消耗能量的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Draw Mox", "魔绘者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a random card costing mox is created in your hand.", "当[creature]被召唤时，会在你的手中随机创建一张需要玛珂的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Support call", "支援呼叫", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a card from your sidedeck is created in your hand.", "当[creature]被召唤时，你立即抽一张副牌堆的牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Drunk", "醉酒", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will strike a random one of the opposing spaces to the left and right of the space across from it.", "[creature]将随机打击它对面左右两侧的任意一个敌方空间。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dwarf", "矮人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is drawn, it will loose one unit of cost, as well as 1 power and 2 health (can't go below 1 health). A unit is defined as: 1 blood, 3 bones, 3 energy, or all mox.", "当[creature]被抽到时，它将失去一个单位的花费，以及1点力量和2点生命（生命值不能低于1点）。一个单位被定义为：1点血量、3点骨头、3点能量或所有玛珂需求。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dying", "奄奄一息", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will die after X number of turns.", "[creature]将在X个回合后死亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "To The Slaughter", "前往屠杀", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of each turn [creature] will eat a random Chicken gaining the same amount of attack as the eaten chicken's health, and gaining the same amount of health as the eaten chicken's attack.", "每回合结束时，[creature]将随机吃掉一只鸡，获得与被吃掉鸡的生命值相同的攻击力，并获得与被吃掉鸡的攻击力相同的生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Electric", "电力制导", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] decalres an attack, they will deal half the damage to cards adjacent to the target.", "当[creature]声明攻击时，其将对目标相邻的卡牌造成一半的伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Enforcer", "执法者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of the owner's turn, [creature] will cause adjacent creatures to attack.", "在持牌人的回合开始时，[creature]将使相邻的造物攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Enrage", "超频领袖", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will empower adjacent allies, increasing their strenght by 2. However, if they perish while empowered, they are permamently removed from your deck.", "[creature]将增加相邻的卡牌2点力量。然而，如果它们在获得力量时阵亡，它们将永久地从你的牌组中被移除。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Entomophage", "噬虫菌体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will deal 2 additional damage to cards of the insect tribe.", "[creature]将对昆虫部落的卡牌造成额外2点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They are a good source of protine I hear.", "我听说它们是蛋白质的好来源。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A familiar will help with attacking when it's adjacent allies attack a card.", "当相邻的卡牌攻击一张牌时，[creature]将帮助其攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fearful", "胆战心惊", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is struck without it resulting in death, it will be returned to its owner's hand.", "当[creature]被攻击但没有死亡时，它将被送回持牌人手中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Charge", "充能感应", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 3 bones to choose an enemy creature that [creature] will strike.", "支付3个骨头选择一个敌对卡牌，[creature]将攻击选择的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Firestarter", "星火燎原", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature will gain the Burning Sigil. The Burning Sigil is define as: Each upkeep, this creature gains 1 strength but looses 1 health.", "当[creature]对另一造物造成伤害时，该造物将获得燃烧印记。燃烧印记被定义为：每个维持阶段，[creature]获得1点力量但失去1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Even once combat is over, it leaves a deadly mark", "即使战斗结束，也会留下致命的痕迹.", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lure", "饵钓潜袭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will cause facedown cards to become face up when attacking.", "[creature]在攻击时会迫使水袭的卡牌翻转。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Submerge are brought back to the surface", "水袭的造物将浮出水面。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature], a targeted card is moved to the owner's side of the board.", "当放置[creature]时，持牌人可以选择一张敌方的卡牌钩其至自己的一侧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone lord 5", "骨魔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] dies, 5 bones are rewarded instead of 1.", "当[creature]死亡时，奖励5根骨头，而不是1根。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Frightened", "惊恐", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a creature moves into the space opposing [creature], [creature] will move away from that card to a random free adjacent spot, while prioritizing slots without any opposing creatures.", "当有卡牌移动到与[creature]相对的空间时，[creature]将远离该卡牌移动到随机的相邻空位，优先选择没有任何对位卡牌的空位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Frightful", "令人生畏", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will cause opposing creatures to move out of the way when it attacks.", "[creature]攻击时将迫使敌方造物让开道路。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is drawn, it will gain one unit blood of cost, as well as one attack and two health.", "当[creature]被召唤时，它将增加1点血祭消耗，以及1点攻击力和2点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "What a large creature you have there", "你那儿的造物多大啊。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Grazing", "放牧", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will regen 1 health if there is no opposing creature.", "在持牌人的回合结束时，如果没有敌方造物，[creature]将回复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This creature will heal 1 Health at the end of it's owner's turn.", "该造物将在其持牌人回合结束时恢复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gripper", "夹持器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil, and try to move the opposing creature with it if it can.", "在持牌人的回合结束时，[creature]将朝着印记标注的方向移动，如果可能，将尝试带着对方造物一起移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The trail they leave behind, hurts.", "它们留下的痕迹让人生疼。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Haste", "迫不及待", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will attack as soon as it gets played on the board if played not during combat.", "[creature]一旦被放置到场上便会立刻攻击一次。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hasteful", "急于求成", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will attack as soon as it gets played on the board. It will not attack during normal combat. It will attack at the start of the owner's turn.", "[creature]将在被放置到场地上后立即攻击。它不会在正常战斗中攻击，它将在持牌人的回合开始时攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Herd", "芸芸众生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will summon a copy of itself each upkeep, up to three times.", "[creature]将在每个维持阶段在同侧的空位上召唤一个自己的复制体，最多三次。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hermit", "隐士", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may be placed on any terrain card. If it is their sigils and stats will be combined, and a name combination will be created.", "[creature]可以放置在任何地形卡上。若如此做，它们的印记和属性将合并，并创建一个名称组合。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "High Tide", "涨潮之时", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, it will grant the waterborne sigil of cards that are played after it on it's side of the board. Does not affect cards that are Airborne.", "当[creature]在场时，它将为同一侧的场上造物赋予水袭印记。不影响具有空袭印记的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The waters rise.", "潮水上涨了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Homing", "宾至如归", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If the opposing slot is empty, and there is a creature in a neighbouring lane, [creature] will attack that creature instead of attacking the opposing slot.", "如果[creature]的对位为空，且其相邻的位置有其他卡牌，[creature]将攻击该牌而不是直接攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hoodini", "变幻莫测", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, it will swap places with the opposing creature.", "当带[creature]被召唤时，它将与对位造物交换位置。如果对位没有卡牌，它将跑到对面。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Host", "巢穴", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is the host of other creatures. It will give you such creature when struck.", "[creature]是其他造物的巢穴。当它被攻击时，会给你特定的造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will cause the opponant to skip their turn when played.", "当[creature]被使用时，将使对手跳过其下一回合。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The sands of time tic away", "时光流逝。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exhaustion", "积劳成疾", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The attack of [creature] will be decreased by the same amount as its lost health.", "[creature]的攻击伤害将减少与它失去的生命值相同的量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hyped", "激动", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will attack at the start of the owner's turn in addition to during normal combat.", "[creature]除了在正常战斗期间攻击之外，也会在持牌人的回合开始时攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Imbuing", "注灵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will get specific buffs depending on which tribe is most promenent in the sacrifices that were used to summon it.", "[creature]将根据用于召唤它的献祭中哪个部落最为突出而获得特定的增益效果。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Inaccurate", "未知之触", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will strike a random one of the opposing spaces to the left and right of the spaces across from it as well as the space in front of it.", "[creature]将对其对位以及对位左侧和右侧的一个随机位置进行攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Old Timer", "岁月年华", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the Start of its owner's turn [creature] will gain +1 attack and will take 1 damage.", "在持牌人的回合开始时，[creature]将获得1点攻击力并受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Injured", "受伤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is hurt and will lose 1 health each time it declares an attack due to the strain of the injuries.", "[creature]每次声明攻击时都会因伤势而损失1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Instant", "转瞬即逝", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will perish immediately after its played.", "[creature]在放置后立即消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Launcher", "启示之作", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of its owner's turn, [creature] will create another creature on a random empty space on the owner's side of the table.", "在持牌人回合结束时，[creature]将在场上同侧的随机空位上创造另一个造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lead (Bones)", "骨骼领导", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 bones to move this card one slot in the direction inscribed on the sigil.", "支付2根骨头，使[creature]向印记标注的方向移动一个槽位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "one can lead  a horse to water...", "人能把马牵到水边...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lead (Energy)", "能量领导", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 energy to move this card one slot in the direction inscribed on the sigil.", "支付2点能量，使[creature]向印记标注的方向移动一个槽位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Leech", "嗜血之蛭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] deals damage, it will heal 1 Health for each damage dealt to a card.", "当[creature]造成伤害时，每对卡牌造成1点伤害将恢复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Vigor from blood!", "活力来自血液！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Left scratch", "左侧爪迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] attacks it will also attack the space on the left of the attacked slot.", "当[creature]攻击时，它还会攻击其左侧的空间。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Life Gambler", "生命赌徒", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will deal 2 damage to the owner in exchange for a 0 to 6 increase in stats. Failing to pay this cost will result in death.", "在持牌人的回合结束时，[creature]将对持牌人造成2点伤害，以换取0到6点属性值的提升。未能支付此费用将导致死亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your blood, their strength!", "你的血液，它们的力量！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Linguist", "语言学家", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, all talking cards on your side of the board get +1 attack.", "当[creature]在场时，同侧场上的所有会说话的卡牌获得1攻击力。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Low Tide", "退潮之时", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, it will negate the waterborne sigil of cards that are played after it on it's side of the board.", "当[creature]在场时，它将移除其同侧造物的水袭印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lullaby", "摇篮曲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] dies, all opposing creatures gain the asleep sigil.", "当[creature]死亡时，所有对立造物获得休眠印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Maneuver", "调遣", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of the owner's turn, [creature] will strafe in the direction inscribed on the sigil if there is a creature in the opposing slot from it. Else it will strafe in the opposite direction inscribed on the sigil.", "在持牌人回合开始时，如果[creature]对面槽位有造物，则将向印记标注的方位移动。否则，将向印记标注的相反方向移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It runs", "它跑了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Medic", "医疗兵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of the owner's turn, [creature] will try heal 1 damage to a friendly card for each instance of Medic.", "在持牌人回合开始时，[creature]将尝试为每张友方卡牌治疗1点生命，前提是存在可医疗单位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A good patching", "不错的医疗。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Medical Aid", "医疗救助", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the opponent's turn, choose a hurt creature on the owner's side to heal for 1.", "对手回合结束时，持牌人选择一个受到伤害的己方造物，恢复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Midas", "点石成金", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] kills a creature, it will generate 1 Foil for each instance of Midas the card has.", "[creature]杀死一个造物时，每有一个点石成金的卡牌实例，就会给予一个货币。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A bounty, paid in full.", "全额支付的赏金。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mount", "固定装置", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cards may be played on top of [creature]. If they are their sigils and stats will be combined, and a name combination will be created.", "其他卡牌可以放置在[creature]上方。若如此做，将合并它们的属性和印记，并创建一个名称组合。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Power from Movement", "运动的力量", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of the owner's turn, [creature] will gain 1 power and 1 health if it moved last round.", "在持牌人的回合开始时，如果[creature]在上一个回合移动过，它将获得1点力量和1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Each move, it grows", "每次移动，它都会成长。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Nurse", "护士", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the opponent's turn, [creature] will heal any adjacent friendly cards.", "在对手回合结束时，[creature]将治愈所有相邻的友方卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Nutritious", "营养丰富", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is sacrificed, it adds 1 power and 2 health to the card it was sacrificed for.", "当[creature]被献祭时，它将为献祭其上场的卡牌增加1点力量和2点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That creature is so full of nutrients, the creature you play comes in stronger!", "那个造物是如此的营养丰富，你所放置的造物将变得更强！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone hoarder 1", "骨礼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, 1 bone is rewarded.", "[creature]被放置时，给予持有者1块骨头。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Opportunist", "机会主义者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will gain 1 power for each instance of Opportunist, when the opposing slot is empty.", "当对位为空时，[creature]将因每个拥有机会主义者印记的实例获得1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It takes it's chance when it gets it.", "它抓住机会，当它得到时。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Paralysis", "瘫痪", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will only attack every other turn. Some effects from sigils may bypass this.", "[creature]将只在奇数回合攻击。一些印记的效果可能会绕过这一限制。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A shocking event.", "令人震惊的事件。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Parasite", "缝合共生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may be placed on top of any card. If it is their sigils and stats will be combined, and a name combination will be created.", "[creature]可以放置在任何卡牌上方。若如此做，将合并它们的属性和印记，并创建一个名称组合。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pathetic Sacrifice", "可悲之血", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is so pathetic, it is not a worthy or noble sacrifice. [creature] is meant to stay on the board, and thus can't be targeted by the hammer.", "[creature]无法被献祭，且无法被锤击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That is not a noble, or worthy sacrifice", "这不是一个卓越的，或值得的献祭。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Picky", "挑肥拣瘦", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] cannnot be summoned by using any free cards as sacrifice.", "[creature]不能通过任何免费卡牌作为祭品召唤。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pierce", "隔山打牛", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] attacks the card in queue behind it's initial target first when declaring an attack.", "[creature]在声明攻击时，首先攻击其初始目标后面的队列中的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "My creatures!", "我的造物！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Poisonous", "剧毒腐蚀", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, the creature that killed it perishes as well.", "当[creature]死亡时，杀死它的卡牌也会死亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Attacking something poisonous, isn't that smart.", "攻击有毒之物，不是明智的选择。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Possessor", "灵魂附身", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, it will grant a random friendly card that is on the board it's base power and health.", "当[creature]死亡时，它将赋予一个随机友方卡牌基于该卡牌的基础力量和生命的属性。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It passes it's strength onto those who remain", "它把力量传给剩余的造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Powerful Possessor", "强力附身", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, it will grant a random friendly card that is on the board it's base plus modified power and base plus modified health.", "当[creature]死亡时，它将赋予一个随机友方卡牌基于该卡牌的当前力量和生命的属性。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Predator", "掠食者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will gain 1 power for each instance of Predator, when the opposing slot has a card.", "当其对位有卡牌时，[creature]将为每个拥有掠食者印记的实例增加1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Prideful", "骄傲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will not attack a card with a power 2 lower than its own.", "[creature]不会攻击比自己攻击力低2的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A creature's pride will be it's downfall.", "一个造物的骄傲就是它的堕落。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Protector", "保护者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will attacks on adjacent allies to hit directly.", "[creature]在场时，攻击相邻卡牌的伤害将改为直接攻击持有者。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They protect their allies, but who protects you?", "它们保护它们的盟友，但谁保护你呢？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Puppets gift", "木偶之礼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "As long as [creature] is on the board any cards with brittle won't die because of brittle.", "只要[creature]在场上，任何拥有脆骨印记的卡牌不会因脆骨印记而死亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Superior Sacrifice", "史诗祭品", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is counted as 4 blood rather than 1 blood when sacrificed.", "[creature]被献祭时被计为4点血量而非1点（此印记对不可献祭的卡牌无效）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ram", "好战之羊", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will try to ram the card infront of it when played, or every upkeep till it succeeds once. It will send the rammed target to the queue if on my side, or back to the hand if on your side. Does not work during combat.", "[creature]在放置时将尝试撞击其面前的卡牌，直至成功为止的每个维持阶段。如果此牌在我方，则将攻击的目标送回后方队列；如果在敌方，则会将攻击的目标送回手牌。战斗阶段无效。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Moving creatures around? How Rude!", "移动造物？多么粗鲁！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Random Strafe", "无形的移动", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is drawn, it will gain a random strafe sigil.", "抽到[creature]，此印记将随机改为一个移动印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "How will it move?", "它将如何移动？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Recoil", "后坐力", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will take 1 damage each time they attack.", "[creature]每次攻击都会受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The strength causes the creature pain.", "力量使它痛苦。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Regen 1", "再生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will regen 1 health.", "在持牌人回合结束时，[creature]将恢复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This creature will heal 1 Health at the end of it's owner's turn.", "这个造物将在持牌人回合结束时恢复1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Regen 2", "双重再生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will regen 2 health.", "在持牌人回合结束时，[creature]将恢复2点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This creature will heal 2 Health at the end of it's owner's turn.", "这个造物将在持牌人回合结束时恢复2点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Regen 3", "三重再生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will regen 3 health.", "在持牌人回合结束时，[creature]将恢复3点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This creature will heal 3 Health at the end of it's owner's turn.", "这个造物将在持牌人回合结束时恢复3点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Regen", "神愈再生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will regen to full health.", "在持牌人回合结束时，[creature]将恢复至满血。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This creature will heal to full Health at the end of it's owner's turn.", "这个造物将在持牌人回合结束时恢复全部生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Repellant", "拒人千里", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, the creature that killed it gets pushed into the back row.", "当[creature]死亡时，杀死它的造物会被推到后排。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Resistant", "抗性提升", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will only ever take 1 damage from most things. Some effects might bypass this.", "[creature]通常只会受到大多数造物的1点伤害。有些效果可能会绕过这一点。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A hardy creature that one is.", "它是一个顽强的造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Resourceful", "资源丰富", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is sacrificed, instead of dying, it loses a random sigil. Resourceful will only remove itself when there are no other sigils on the card.", "当[creature]被献祭时，它不会死亡，而是失去自身已有的一个随机印记。资源丰富仅在卡牌上没有其他印记时才会移除自己。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Retaliate", "反戈一击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will strike those who strike their adjacent allies.", "[creature]将对攻击其相邻卡牌的敌人进行反击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Right scratch", "右侧爪迹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] attacks it will also attack the space on the right of the attacked slot.", "当[creature]攻击时，它还会攻击其右侧的空间。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rushing march", "急行军", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of its owner's turn, [creature] will move in the direction inscribed on the sigil, however if it hits a card whilst moving, [creature] will stop and the card it hit will perish.", "在持牌人的回合结束时，[creature]将按印记标注的方向移动，但如果在移动过程中遇到卡牌，[creature]将停止，并且被击中的卡牌将消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Schooling", "水袭指导", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will grant creatures with the waterborn 1 power.", "[creature]将赋予拥有水袭印记的造物1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The waterborn stick together.", "水袭造物团结一心。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a targeted card cut in two.", "当[creature]被召唤时，剪碎一张目标卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "My card!", "我的卡牌！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shapeshifter", "损伤易形", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is ever changing. It will change its form once it's struck.", "[creature]一直在变化。一旦被击中，它就会改变形态。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Short", "短小精悍", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will not be blocked by an opposing creature bearing the airborn sigil.", "[creature]不会被带有空袭印记的造物阻挡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sickness", "疾病肆虐", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will loose 1 attack each time it declares an attack.", "[creature]每次声明攻击时都会失去1点攻击力。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The creature's strength leaves it as it strikes.", "造物的力量在攻击时流失。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone lord 6", "骨神", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] dies, 6 bones are rewarded instead of 1.", "当[creature]死亡时，奖励6根骨头，而不是1根。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sluggish", "缓慢", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will not attack during normal combat. It will instead attack after the Opponent's cards attack.", "[creature]在正常战斗中不会攻击。它将改为在对手的卡牌攻击后进行攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A bit slow there eh?", "有点慢，嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Song of sleep", "安眠曲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If a creature moves into the space opposing [creature], that creature will obtain the asleep sigil.", "如果一个造物移动到[creature]对面的空间，该造物将获得休眠印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spawner", "创造性冲刺", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of its owner's turn, [creature] will move in the direction inscribed on the sigil and will create another creature in its old space.", "在持牌人的回合结束时，[creature]将按照印记标注的方向移动，并在其原来的位置创造另一个造物。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Stampede", "席卷狂潮", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will cause adjacent creatures to attack when played on the board if played not during combat.", "[creature]如果在非战斗状态下在场地上放置，将导致相邻的造物攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Power in Numbers", "人多力量大。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sticky", "如胶似漆", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If the card opposing [creature] moves, [creature] will try to move with it", "如果[creature]对位的卡牌移动，[creature]将尝试与其一起移动.", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Velocity", "风驰电掣", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil. If it is able to move, it will gain 1 power and 1 health.", "在持牌人的回合结束时，[creature]将向印记标注的方向移动。如果它能够移动，它将获得1点力量和1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Strong Wind", "强风吹拂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If [creature] is on the board, negate the airbone sigil of all cards that are played after it.", "如果[creature]在场上，则取消其后出场的所有卡牌的空袭印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Wind forces a landing.", "强风迫使着陆。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Submerged Ambush", "水下伏击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will deal 1 damage to cards that attacked over it while it was face-down. Does not affect cards that are Airborne.", "[creature]在它潜水时，将对攻击过它位置的卡牌造成1点伤害。不影响带有空袭印记的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It strikes from the water.", "它的攻击来着水下。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Swallower", "吞噬者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "After [creature] attacks, it will destroy the card it attacks if it has less health than it and heal to full health.", "在[creature]攻击后，如果它的生命值低于它所攻击的卡牌，它将摧毁它所攻击的卡牌并恢复所有生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gone in one gulp.", "一饮而尽。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sympathetic", "同情", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will only attack if the opposing creature has more or equal health to it.", "[creature]只有当对位造物的生命值不小于它时，才会攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Take-Off (Bones)", "骨驱空袭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 bones to give this card Airborne till the start of owner's next turn.", "支付2个骨币，使这张卡牌直到持牌人下一个回合开始时获得空袭印记的效果。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spread your wings and fly.", "展翅飞翔。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Take-Off (Energy)", "电驱空袭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 2 energy to give this card Airborne till the start of the owner's next turn.", "支付2点能量，使这张卡牌直到持牌人的下一个回合开始时获得空袭印记的效果。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Terrified", "惊慌失措", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a creature moves into the space opposing [creature], [creature] will move away from that card to a random free adjacent spot while pushing any creatures in it's way, while prioritizing slots without any opposing creatures.", "当有卡牌移动到与[creature]相对的空间时，[creature]将远离该卡牌移动到随机相邻的空位，同时推开挡在其路上的任何造物，优先选择没有任何相对造物的槽位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Thick Shell", "厚重甲壳", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When attacked, [creature] takes 1 less damage.", "当[creature]被攻击时，少受1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The thick shell on that creature protected it from one damage!", "那个造物身上的厚壳保护它少受1点伤害！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will try to steal a random default sigil from an opposing creature when played, or at the start of the owner's turn until it does.", "[creature]在战斗时或在持牌人的回合开始时，将尝试从对位造物那里偷取一个随机的默认印记，直到成功为止。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If only I could steal the moon...", "要是能偷月亮就好了..", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone prince 3", "骨后", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] dies, 3 bones are rewarded instead of 1.", "当[creature]死亡时，奖励3根骨头，而不是1根。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone hoarder 3", "三重骨礼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, 3 bones are rewarded.", "[creature]被放置时，给予持有者3块骨头。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tooth Bargain", "牙齿交易", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, it will put 1 point of damage of it's opponent's side of the scale. When it perishes, it will put 2 damage on the owner's side of the scale.", "当[creature]被召唤时，它将对对手的天平一侧造成1点伤害。当它死亡时，它将对持牌人的天平一侧造成2点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A deal with a devil I see...", "我看到了和魔鬼的交易..", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toothpuller", "拔牙器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will add one point of damage to the opponent's scale.", "在持牌人回合结束时，[creature]将对对手的天平造成一点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That Hurts", "那很疼。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tooth Shard", "牙齿碎片", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will generate 1 foil when hit, if it lives through the attack.", "[creature]被攻击时，如果它存活下来，将给予持有者一个货币。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A splinter of gold.", "一小块金子。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toxin", "混合毒素", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature looses 1 power and 1 health.", "当[creature]对另一造物造成伤害时，该造物失去1点力量和1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "All things can be worn down, and in different ways.", "所有的东西都可以用不同的方式磨损。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toxin (Deadly)", "致命毒素", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature gains the Dying Sigil. The Dying Sigil is defined as: [creature] will die after 2 number of turns.", "当[creature]对另一造物造成伤害时，该造物获得奄奄一息印记。奄奄一息的定义是：带有此印记的卡牌将在2回合后死亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Even once combat is over, it leaves a deadly mark", "即使战斗结束，也会留下致命的痕迹.", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toxin (Sickening)", "残废毒素", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature gains the Sickness Sigil. The Sickness Sigil is defined as: When ever a creature bearing this sigil declares an attack, they will loose one attack.", "当[creature]伤害另一个造物时，该造物获得疾病肆虐印记。疾病肆虐被定义为：每当带有此印记的造物宣布攻击时，它们将失去一点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Even once combat is over, it leaves sickness spreads in what it fights.", "即使战斗结束，疾病也会在战斗中传播。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toxin (Strength)", "力量毒素", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature looses 1 power.", "当[creature]伤害另一个造物时，该造物失去1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Even once combat is over, strength leaves it's target", "即使战斗结束，力量也会离开它们。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Toxin (Vigor)", "生命毒素", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature looses 1 health.", "当[creature]对另一造物造成伤害时，该造物失去1点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Trample", "践踏", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] deals overkill damage to a card, the overkill damage will be sent to the owner.", "当[creature]对另一卡牌造成超额伤害时，超额伤害将传给该牌的持牌人。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A stampede can not be stopped.", "践踏永不停止。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Transform Chicken (Enemy Only)", "易形鸡（仅敌人）", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will transform a random creature on the board on the opponent's side into a Chicken. A Chicken is defined as 1 Attack, 1 Health.", "[creature]将在每个持牌人的回合开始时使对方场地上的一个随机造物变成鸡。鸡被定义为：1点力量，1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Transform Chicken (Loose Cannon)", "易形鸡（全场）", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will transform a random creature on the board into a Chicken. A Chicken is defined as 1 Attack, 1 Health.", "[creature]将在每个持牌人的回合开始时使全场的一个随机造物变成鸡。鸡被定义为：1点力量，1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Transform Chicken (Opposing)", "易形鸡（对位）", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a creature is played opposing [creature] it will turn into a Chicken. A Chicken is defined as 1 Attack, 1 Health.", "当一个造物与[creature]对位时，它会变成一只鸡。鸡被定义为：1点力量，1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Transient", "昙花一现", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will return to your hand.", "在持牌人回合结束时，[creature]将回到其手中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The creature blinks back into the owner's hand at the end of their turn.", "该造物在回合结束时跑回持牌人手中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tribal Ally", "部落盟友", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, A card of the same tribe is created in your hand. No tribe counts as a tribe of tribeless.", "当[creature]被召唤时，你手中将产生一张与之相同部落的卡牌。无部落的卡牌视为无部落的部落。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It calls for it's kin.", "它需要它的亲属。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tribal Tutor", "部落囤积", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, you may search your deck for a card of the same tribe and take it into your hand. No tribe counts as a tribe of tribeless.", "当[creature]被召唤时，你可以从牌库中搜寻一张与之相同部落的卡牌并将其加入你的手牌。无部落的卡牌视为无部落的部落。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tribe Attack", "部落攻击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, all other cards on your side of the board of the same tribe will gain +1 attack.", "当[creature]在场上时，同一侧所有相同部落的卡牌攻击力+1。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tribe Health", "部落生命", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "While [creature] is on the board, all other cards on your side of the board of the same tribe will gain +1 health.", "当[creature]在场上时，同一侧所有相同部落的卡牌生命值+1。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbulent Waters", "混沌水域", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will force other creatures with waterborne to resurface and take 1 damage at the start of the owner's turn.", "[creature]将迫使其他拥有水袭印记的造物浮出水面，并在持牌人的回合开始时受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The waters be rough.", "水面波涛汹涌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone prince 2", "骨臣", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] dies, 2 bones are rewarded instead of 1.", "当[creature]死亡时，奖励2根骨头，而不是1根。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone hoarder 2", "双重骨礼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, 2 bones are rewarded.", "[creature]被放置时，给予持有者2块骨头。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Underdog", "扶弱锄强", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] can only be played when you are losing.", "[creature]只能在您处于劣势时使用。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Vicious", "凶相毕露", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is attacked, it gains 1 power.", "当[creature]被攻击时，它获得1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A hit just makes it angry.", "一次攻击只会让它生气。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Warper", "穿场者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of its owner's turn, [creature] will move to the right, jumping over any creatures in its path, if it encounters the edge of the board, it will loop over to the other side.", "在其持牌人的回合结束时，[creature]将向右移动，穿过其路径上的任何造物，如果遇到场地边缘，它将回到最左侧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wild hunger", "狂野饥饿", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of its owner's turn, [creature] will move in the direction inscribed on the sigil, however if it hits a card whilst moving, [creature] will stop, the card it hit will perish and [creature] will gain 1+/1+.", "在持牌人的回合结束时，[creature]将按印记标注的方向移动，若在移动过程中遇到其他卡牌，[creature]将停止移动，被撞到的卡牌将消亡，并且[creature]将获得1点力量和1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Withering", "凋零", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] will perish at the end of the opponant's turn.", "[creature]将在对手回合结束时消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Zapper", "瘫痪之触", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] damages another creature, that creature will gain the Paralysis Sigil. The Paralysis sigil is defined as: A card bearing this sigil will only attack every other turn.", "当[creature]对另一造物造成伤害时，该造物将获得瘫痪印记。瘫痪印记定义为：带有此印记的卡牌将每隔一回合攻击一次。", Language.ChineseSimplified);
        }
    }
    public class BittysSigilsMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for BittysSigils Mod");
            // Ability
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blocked on both sides. No Eggs for you.", "两侧堵塞。没有蛋给你。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "No empty spaces. No firs for you.", "没有空位，无法给你大冷杉。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Explosive Squirrel Reproduction", "松鼠泛滥", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, fill your side deck with squirrels.", "当打出[creature]时，你的副牌组将被松鼠填满。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hauler", "运输者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil. Adjacent friendly creatures will be pulled in the same direction.", "在持牌人的回合结束时，[creature]会向印记标注的方向移动。相邻的友方生物会被拉向同一方向。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heart Swap", "心灵交换", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, all cards on the board swap their power and health.", "当打出[creature]时，场上所有卡牌将交换其力量和生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mutual Hire", "相互雇佣", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a copy of it is created in the opposing space.", "当打出[creature]时，会在对方区域创造一个它的副本。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Charged Barrage", "充能弹幕", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 4 life to increase the power of all cards on your side of the board by 1.", "支付4点生命值，增加同侧场上所有卡片1点力量。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Health Roll", "生命骰子", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 1 Energy to set the health of [creature] randomly between 1 and 6.", "支付1点能量，将[creature]的生命值设置为1到6的随机数字。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sigil Roll", "印记骰子", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pay 4 Life to add a random sigil to [creature].", "支付4点生命值，将一个随机印记添加到[creature]上。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Wildlife Camera", "野兽相机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] kills another card, a copy of the killed card is created in your hand.", "当[creature]击杀另一张卡牌时，会在你的手中创造该被击杀卡牌的副本。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dusty Quill", "尘埃羽毛笔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Whenever a creature dies while [creature] is on the board, a corpse is raised in it's place. Corpses are defined as: 0/1.", "当[creature]在场上时，若其他造物死亡，会在其位置召唤一具尸体。尸体被定义为：0点力量，1点生命。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bleached Brush", "漂白之笔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, the opposing card will lose all its sigils.", "当[creature]被打出时，对位的卡牌将失去所有印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Strong Soul", "剽悍之魂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not recieve sigils from another card.", "[creature]不能接受其他造物的印记转移。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weak Soul", "孱弱之魂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not have its sigils transferred to another card.", "[creature]不能转移自己的印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Nonexistent Soul", "缥缈之魂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not have sigils transferred to, or from this card.", "[creature]不能接受其他造物的印记转移和转移自己的印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pyrophobia", "恐火症", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not be buffed at campsites.", "[creature]不能在篝火事件获得增益。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pyrophobia (Attack)", "恐火症（力量）", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not recieve power buffs from campsites.", "[creature]不能从篝火事件获得力量增益。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pyrophobia (Health)", "恐火症（生命）", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not recieve health buffs from campsites.", "[creature]不能从篝火事件获得生命增益。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Repulsion", "排斥", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not attack.", "[creature]不能攻击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mysterious Mushrooms", "神秘蘑菇", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the turn, if there is a card on either side of [creature], they are fused together.", "回合结束时，如果[creature]的两侧有牌，它们会融合在一起。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move the opposing card and itself in the direction inscribed in the sigil.", "在持牌人的回合结束时，[creature]会带动对位卡牌和自身向印记标注的方向移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Counter Attack", "反伤刺甲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Once [creature] is struck, the striker is then dealt damage equal to this card's attack.", "一旦[creature]被攻击，攻击者将受到等同于这张卡牌攻击力的伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mirror Counter", "镜面刺甲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Once [creature] is struck, the striker is then dealt damage equal to the striker's attack.", "一旦[creature]被攻击，攻击者将受到等同于攻击者攻击力的伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Board Shifter", "全场移相", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil. All cards will shift in the same direction, looping to the other edge of the board.", "在持牌人的回合结束时，[creature]将按照印记标注的方向移动。所有卡牌将朝同一方向移动，绕到场地的另一侧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Board Shifter (Owner)", "友军移相", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil. Friendly cards will shift in the same direction, looping to the other edge of the board.", "在持牌人的回合结束时，[creature]将按照印记标注的方向移动。友方卡牌将朝同一方向移动，绕到场地的另一侧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Board Shifter (Opposing)", "敌军移相", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move in the direction inscribed in the sigil. The opposing cards will shift in the same direction, looping to the other edge of the board.", "在持牌人的回合结束时，[creature]将按照印记标注的方向移动。对手的卡牌将朝同一方向移动，绕到场地的另一侧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deathbell", "丧钟", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of the battle phase, [creature] perishes.", "每个回合开始时，[creature]会消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Clockwise", "顺时针", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, move all cards on the board clockwise.", "当一张[creature]被打出时，场上所有卡牌顺时针移动一格。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Stubborn", "顽固不化", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not have its stats swapped.", "[creature]不能交换其属性。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of each turn [creature] is on the board, move all cards on the board clockwise.", "每回合结束时，若场上存在一张[creature]，则将场上的所有卡牌顺时针移动一格。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fleeting", "稍纵即逝", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the turn [creature] will be discarded from your hand.", "一张[creature]将在回合结束时被弃置。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Soul Link", "灵魂链接", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, all other allied cards bearing this sigil perish as well.", "当[creature]消亡时，所有其他带有此印记的友方卡牌也将随之消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hollow Draw", "空洞抽取", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, discard the oldest card in your hand, draw a card.", "当[creature]被打出时，弃掉你手中最早抽到的卡牌，重新抽一张牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hollow Barrage", "空洞弹幕", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, all cards take 1 damage.", "当[creature]被打出时，场上所有卡牌受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gem Phobic", "宝石恐惧", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If [creature]'s owner controls a Mox card, [creature] perishes.", "若[creature]的持有者场上拥有任何玛珂牌，[creature]将消亡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Foolhardy", "鲁莽", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] may not recieve modifications from any source.", "[creature]不能从任何事件中获得修改。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Jumper", "跳跃者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move itself to the first empty space in the direction inscribed in the sigil.", "在持牌人的回合结束时，[creature]会自行向印记标注的方向移动至第一个空位。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Super Sprinter", "冲刺狂人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] will move itself as far as possible in the direction inscribed in the sigil.", "在持牌人的回合结束时，[creature]会尽可能地向印记标注的方向移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eggist", "蛋之艺术", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, an Egg is created on each empty adjacent space.", "当打出[creature]时，在每个相邻的空位上各创建一个蛋。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fir Caller", "唤林者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, a Fir is created in each of the owner's spaces.", "当[creature]被打出时，在持牌人的每个空位上创造一个大冷杉。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flipper", "浮光掠影", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the owner's turn, [creature] swaps its stats.", "在持牌人回合结束时，[creature]会交换其属性。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fleeting Draw", "消逝之手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, draw 1 card with Fleeting.", "当一张[creature]被打出时，获得一张带有稍纵即逝印记的牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Outcast", "流浪者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the end of the turn, [creature] is shuffled into the deck.", "回合结束时，[creature]会被洗入你的牌组。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hollow Repeater", "空洞中继", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] perishes, all On Play sigils on that card are activated.", "当[creature]消亡时，该卡牌上所有上场时触发的印记将被激活。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Replenish", "买一送一", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is drawn, draw a card.", "当一张[creature]被抽到时，再抽一张牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Target Swap", "目标交换器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is played, Target a Card: the card's stats are swapped.", "放置[creature]时，持牌人选择一张牌：该牌的力量和生命数值将被交换。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sacrificial Growth", "祭祀生长", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When [creature] is sacrificed, it will grow into a more powerful form.", "当[creature]被献祭时，它将成长为更强大的形态。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ruby Transformer", "红宝石易形", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If [creature]'s owner controls a Ruby Mox, [creature] will be transformed; otherwise [creature] will transform into its base form.", "若[creature]的持牌人场上拥有红宝石玛珂，[creature]将转变为另一种形态；否则[creature]将转变为其基础形态。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gemify", "宝石增益", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] gains buffs based on moxes in play on the owner's side. Orange is 1 Power. Green is 2 Health. Blue is lower Cost.", "[creature]根据进场时持牌人拥有宝石获得增益。橙色：增加1点力量；绿色：增加2点生命；蓝色：降低花费成本。", Language.ChineseSimplified);

            // Card
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Corpse", "尸体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "TestCard", "测试卡牌", Language.ChineseSimplified);
        }
    }
    public class BittysChallengesMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for BittysChallenges Mod");
            // DialogueEvent
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Is that a clover?", "那是三叶草吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I see.", "原来如此。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oh?", "哦？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Did you not like having a stacked deck?", "你不喜欢被发牌针对吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That's fine with me.", "我无所谓。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It will be more fair this way anyways.", "反正这样更公平些。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "oh?", "哦？", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "i will be sure to put it to good use.", "我一定会好好利用它的。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the ouroboros has followed you.", "衔尾蛇已追随你而来。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "it's fangs are beared, and it's ready for another fight.", "它已露出毒牙，准备再战一场。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the unyielding ouroboros has returned,", "不屈不死的衔尾蛇已然归来，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "growing stronger every death.", "每次死亡都令其更加强大。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "as inevitable as death,", "如同死亡般不可避免，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the ouroboros has returned.", "衔尾蛇已然归来。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a serpent slithers out from the undergrowth.", "一条蛇从灌木丛中蜿蜒而出。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "perhaps you have seen it before?", "或许你曾见过它？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the ouroboros has died.", "衔尾蛇死了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "and yet, it will return.", "然而，它终将归来。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the serpent's wrath has been delayed.", "蛇的怒火已被延缓。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "for now.", "暂且如此。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the ouroboros only grows stronger from death.", "衔尾蛇只会因死亡而愈发强大。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "it will be back.", "它终将归来。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a-ah, the sigils...", "啊-啊，印记……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "o-oh, the power...", "哦-哦，这股力量……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a-ah, the health...", "啊-啊，生命……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Chrysomallos, the golden ram.", "金羊克律索马罗斯。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "what a glorious pelt....", "多么华美的毛皮啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The golden ram.", "金羊。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "catch it before it escapes.", "趁它逃走前抓住它。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a rare sight", "难得一见", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "it will not stay for long", "它不会久留", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "what glittering wool,", "多么闪耀的羊毛啊，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "attached to such a rare creature.", "竟附着在如此稀有的生物身上。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "oh?", "哦？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a rare chance to get a rare pelt.", "这可是获得稀有毛皮的难得机会。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "best make the most of it.", "最好别错过。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You slay the glimmering creature, stealing its pelt.", "你击杀了这只发光的生物，剥下了它的毛皮。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The end of such a glorious creature.", "如此辉煌的生灵就此陨落。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "And what a glorious pelt you have obtained.", "而你获得了何等华美的皮毛。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Chrysomallos...", "克律索马罗斯……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "How tragic your tale is...", "你的故事何其悲惨……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "To be killed for your pelt...", "竟为皮毛而遭屠戮……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Golden Ram lives another day.", "金羊又活过了一天。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Time's up.", "时间到了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Golden Ram has found an escape route.", "金羊已经找到了逃脱路线。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The glimmer of the Golden Ram's fur blinds you,", "金羊皮毛的闪光晃花了你的眼，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "giving it the opportunity to escape.", "让它得以趁机逃脱。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your [v:0] has taken a devastating blow from the [v:1].", "你的[v:0]遭到了[v:1]的毁灭性打击。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You will not be able to take it with your caravan.", "你将无法将其带进队伍。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You won't be seeing your [v:0] again,", "你再也见不到你的[v:0]了，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It has taken too much damage.", "它承受了太多伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Did you permanently kill your [v:0] on purpose?", "你是故意永久牺牲[v:0]的吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A shame...", "真可惜……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ha! There be my first mate!", "哈！我的大副来了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Argh! There be snakes on me ship as well!", "啊！我的船上也有蛇！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ha!", "哈！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I should hire ye to get rid of the rest of them!", "我该雇你把剩下的家伙都解决掉！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ha! It's dead!", "哈！它死了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "what?", "什么？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pirates?", "海盗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...", "……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I'll allow it.", "准了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "what?", "什么？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "cheating?", "作弊？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "how dissapointing...", "真令人失望……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...", "……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the game will be soured from a pitifully easy ascent.", "这场游戏将因你卑劣的轻松取胜而索然无味。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "cheater...", "作弊者……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Have you no shame?", "你难道不知羞耻吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "To cheat so blatantly...", "如此明目张胆地作弊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you should be dead.", "你本该命丧黄泉。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "and yet...", "然而……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "how dissapointing...", "真是令人失望……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...", "……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I won't tolerate this for much longer...", "我不会再容忍太久了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Enough of this.", "适可而止吧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Yer not dead?", "你没死？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "back to normal then?", "那么……恢复正常了？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I'll admit, I had gotten used to the changes...", "我得承认，我已经习惯那些改动了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weak Cards?", "虚弱卡牌？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This is hard to explain...", "这很难解释……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Perhaps they are sick? Yes.", "也许他们生病了？没错。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A crippling disease afflicted your meager troupe of creatures.", "一种致残疾病侵袭了你那可怜的造物们。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Waterborne Cards?", "水生卡牌？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This is hard to explain...", "这很难解释……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Perhaps a mutation? Yes.", "或许是变异？没错。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your caravan of creatures had a startling mutation,", "你的造物队伍发生了惊人的变异，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They could only survive in the water.", "它们只能在水域中存活。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Paralyzed Cards?", "麻痹卡牌？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm...", "唔……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your group of creatures were fatigued from the long journey,", "你的造物们因长途跋涉而精疲力竭，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "but there would be a long way to go yet.", "但前路依然漫长。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weak Souled Cards?", "魂弱之牌？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm...", "唔……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You will not be able to extract their souls into new creatures,", "你无法将它们的灵魂萃取为新造物，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "For better or worse...", "塞翁失马……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The lives of past challengers weighed down on you...", "过往挑战者的命数正压在你身上……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "How to explain this...", "该怎么解释呢……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You were running low on supplies that day...", "那天你的补给所剩无几……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You'll have fewer [c:G][v:0]s[c:] to work with.", "你能使用的[c:G][v:0][c:]会更少。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "An abundance of [c:G][v:0]s[c:]...", "[c:G][v:0][c:]的大爆发……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Must be mating season...", "想必是交配季节到了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Environmental effects?", "环境效果？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "how interesting...", "真有意思……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "In order to proceed,", "若要前行，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you had to slog through the wetter parts of the swamp.", "你不得不艰难跋涉穿过沼泽的湿泞区域。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The thick[c:G][c:G]mud[c:] stuck to your boots, and hindered your movements...", "黏稠的[c:G]淤泥[c:]粘附靴底，拖缓了你的步伐……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The frigid air was not the only obstacle in your way,", "刺骨的寒风并非你唯一的阻碍，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the harsh ice and unforgiving snow also stood in your path.", "严酷的冰原与无情的积雪同样横亘于前。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "before long you found yourself in...", "很快你便置身于……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a [c:B]hailstorm.[c:]", "[c:B]冰雹风暴[c:]之中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You found yourself cornered against a sheer rock wall,", "你发现自己被逼到了陡峭的石壁前，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the [c:G]cliffside.[c:]", "一面[c:G]悬崖边缘[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Against the cold stone, there would be less space to fight.", "面对冰冷的岩石，战斗空间将变得更为狭小", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The mycologists had left one of their experiments behind,", "菌学家们留下了一项实验品，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "unbeknownst to them, it began to fester and grow.", "他们未曾察觉，这实验品已开始溃烂滋长。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "even the creatures fighting you would not be safe from the [c:G]fungal mass.[c:]", "即便是与你交战的生物也难逃[c:G]真菌团块[c:]的侵蚀。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You stumbled across one of the Prospector's Camps.", "你无意中发现了一处矿工的营地。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The camp was filled with prospecting tools.", "营地里堆满了采矿工具。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "pickaxes, headlamps...", "镐头、矿灯……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "and [c:bR]dynamite.[c:]", "还有[c:bR]炸药[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You came across one of the Angler's Ponds.", "你遇到了钓鱼人的一个池塘，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the area stank of rotting fish", "空气中弥漫着腐鱼的恶臭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "emanating from the nearby abandoned buckets of [c:dB]bait.[c:]", "气味来自附近废弃的[c:dB]鱼饵[c:]桶。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You came across one of the Trapper's Hunting Grounds.", "你发现了一处猎人的狩猎场。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the stench of blood hung in the air...", "空气中弥漫着血腥味……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you noticed the numerous [c:G]traps[c:] lying in wait.", "你注意到地上潜伏着许多[c:G]陷阱[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You came upon a strange [c:bR]totem.[c:]", "你遇到一座奇怪的[c:bR]图腾[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a mysterious energy swirled around it,", "神秘能量在其周围盘旋，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the creatures nearby seem more agressive than usual...", "附近的生物似乎比往常更具攻击性……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "a [c:bR]Blood Moon.[c:]", "一轮[c:bR]血月[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Er...", "呃……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You...", "你……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...", "……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...What?", "……什么？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I am at a loss for words.", "我无言以对。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The wind was howling around you.", "狂风在你周围呼啸。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Stuck in the middle of a blizzard,", "被困在暴风雪中央，", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You heard rumbling from the mountains above.", "你听见上方山脉传来隆隆巨响。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Here it comes...", "它来了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "an [c:B]avalanche.[c:]", "一场[c:B]雪崩[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You stumble across a strange black stone.", "你偶然发现了一块诡异的黑色石碑。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A stone tablet sits in front of it, clearly made for sacrifices.", "碑前摆放着用于献祭的石制祭坛。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Perhaps a certain creature may cause a reaction?", "或许特定造物能引发异象？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The obelisk trembles in delight.", "方尖碑因喜悦而震颤。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A goat is truly a worthy sacrifice.", "山羊确实是上等祭品。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You won't be seeing it again.", "你再也见不到它了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The obelisk rumbles with anger.", "方尖碑因愤怒而震颤。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A pelt is a truly pitiful sacrifice.", "毛皮实在是可悲的祭品。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...", "……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...That is not a proper sacrifice.", "……这算不上真正的献祭。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Stop this.", "住手。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You...", "你……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This is bloodshed without meaning.", "这是无谓的杀戮。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[v:0]...", "[v:0]……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hmm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "What is this?", "这是何物？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heh heh heh...", "嘿嘿嘿……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ye walked into th' pirate's cove!", "你闯进海盗老窝了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Me crew will get rid of ye quick!", "老子的小弟们马上送你上路！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You carve through the thick underbrush and foilage.", "你劈开茂密的灌木与枝叶。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The trees blotting out the sun...", "树冠遮蔽了阳光……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "As you travel, you hear the woods start to creak around you.", "行进间，你听见周遭的树林开始发出吱呀声响。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You should know better than to walk in the darkness...", "你该明白不该在黑暗中穿行……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "As your caravan of creatures travels, you hear a rushing sound.", "当你的造物队伍行进时，你听到一阵湍急的声响。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You climb to a higher place as water flows around you.", "你攀至高处，四周水流奔涌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You are caught in a [c:B]flood.[c:]", "你被困在[c:B]洪水[c:]之中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Only the terrain and flying creatures will be able to avoid the waters.", "只有地形卡与飞行造物能避开洪水侵袭。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "As your caravan of creatures moves across a clearing, the winds blow stronger.", "当你的造物队伍穿过一片空地时，风势渐强。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A strong breeze greets your face, and you grasp onto the surroundings for dear life.", "一阵强风迎面袭来，你为保命紧紧抓住周围物体。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your creatures are blown [c:G]airborne.[c:]", "你的造物们被吹得[c:G]腾空而起[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Only burrowing and submerged creatures will be able to avoid the gusts.", "唯有土遁或潜水的造物能避开这股狂风。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Breeze blows...", "微风轻拂……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You come across a pile of corpses.", "你发现了一堆尸体。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A strange energy swirls around them as you approach.", "当你靠近时，一股诡异的能量在尸体周围盘旋。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Then...", "随后……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:R]The dead walk.[c:]", "[c:R]亡者苏生[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:R]The dead walk.[c:]", "[c:R]亡者苏生[c:]。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You came across an overgrown glade.", "你遇到一片葱郁的林间空地。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The trees seemed taller, and stronger than usual.", "树木似乎比往常更加高大茁壮。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your creatures grew faster as well.", "你的造物们也生长得更快了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "<color=#25C102>Flash Growth.</color>", "<color=#25C102>急速生长</color>。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "<color=#25C102>Flash Growth.</color>", "<color=#25C102>急速生长</color>。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You're decreasing the number of vessels you have?", "你在减少容器数量？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Surely a player as bad as you needs the extra chump blockers?", "像你这么菜的玩家不该多留些炮灰挡刀吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You'll see.", "等着瞧吧", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You're increasing the number of vessels you have?", "你要增加容器数量？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Makes sense.", "合理。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "After all, a player as bad as you needs the extra chump blockers.", "毕竟像你这么菜的玩家需要多点炮灰挡刀。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[v:0] vessels...", "[v:0]个容器……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oh?", "哦？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You couldn't even stick to the changes?", "你连这点改动都坚持不了？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pathetic.", "可悲。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oh?", "哦？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "My own Ourobot?", "我自己的衔尾蛇机器人？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You must be masochistic if you thought this was a good idea.", "觉得这是个好主意，你肯定有受虐倾向。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your funeral.", "你自找的。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "There it goes.", "它没了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You just made it stronger.", "你只是让它变得更强了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Of course, you knew that already.", "当然，你早就知道会这样。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I'm not worried.", "我可不担心。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It'll come back to crush you later.", "它迟早会回来碾碎你。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weaker starting cards?", "初始卡牌削弱了？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "As if one health will make a difference.", "区区1点生命值能改变什么。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm?", "嗯？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Were my environments not good enough for you?", "莫非我的环境牌还入不了你的眼？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fine.", "行吧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hm...", "嗯……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You have found a...", "你发现了一处……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Robot scrapyard.", "机器人坟场。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "There's broken down robots everywhere.", "到处都是报废的机器人。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Every robot in this area dies twice.", "这片区域的每个机器人都会死两次。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It's the scrapyard again.", "又是废料场。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You know the drill.", "规矩你都懂。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eugh", "呃", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This is one of [c:O]HIS.[c:]", "这是[c:O]他[c:]的东西。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your... transformer bots will be more effective here.", "你的……易形者机器人在这里会更有效。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They'll transform when played.", "打出时它们会变形。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You'll see.", "等着瞧吧。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your transformer bots will be more effective here.", "你的易形者机器人在这里会更有效。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They'll tranform when played.", "打出时它们会变形。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A favorite of mine.", "这是我最中意的机制。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of each of your turns all cards will be moved clockwise.", "在你的每个回合开始时，所有卡牌都会顺时针移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I'm sure you've seen it before.", "想必你早见识过了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At the start of each of your turns all cards will be moved clockwise.", "在你的每个回合开始时，所有卡牌都会顺时针移动。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You've seen it before.", "你之前见过这个效果。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ah...", "啊……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your <color=#25C102>G</color>[c:O]E[c:][c:B]M[c:]s will be more useful.", "你的<color=#25C102>宝</color>[c:O]石[c:][c:B]们[c:]会更有用。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "More useful than [c:R]he[c:] ever was able to make them...", "比[c:R]他[c:][c:]能创造的更有用……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...As long as you keep that one alive.", "……只要你让那东西活着。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your <color=#25C102>G</color>[c:O]E[c:][c:B]M[c:]s will be more useful.", "你的<color=#25C102>宝</color>[c:O]石[c:][c:B]们[c:]会更有用。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "...As long as you keep that one alive.", "……只要你让那东西活着。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heh", "呵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This one will be quite...", "这个会相当……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shocking.", "电人。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You find yourself in an electrical storm.", "你发现自己身处雷暴之中。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "When a card is played, it will take 1 damage.", "打出卡牌时会受到1点伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If it survives, it'll be stronger for a bit.", "若能存活则会暂时变强。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mole Firstmate", "鼹鼠大副", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ourobot", "衔尾蛇机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Living {0}", "活了的{0}", Language.ChineseSimplified);
        }
    }
    public class P03SigilariumMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for P03Sigilarium Mod");
            // Card
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Urch1n Cell", "机械海胆电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Charge!", "充能！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Upgrade!", "升级！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Zap!", "电击！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blast!", "炸裂！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Defend!", "防御！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Junk", "废料堆", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "S4LM0N", "机械鲑鱼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Seed", "种子", Language.ChineseSimplified);
    ...
    public class P03InKayceesModMod
    {
        public static void RegisterTranslations()
        {
            ...
            // Card: Base
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mega Gunner", "四枪手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Triple Gunner", "三枪手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hurt-n-Heal Conduit", "伤害治疗管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "50er", "黄金矿工", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Scrap Pile", "废料堆", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "ALPHA.DOC", "阿尔法.DOC", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "BETA.DOC", "贝塔.DOC", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "GAMMA.DOC", "伽马.DOC", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Basic Token", "基础骨币", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Improved Token", "强化骨币", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rare Token", "稀有骨币", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blockchain", "区块链", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "GollyCoin", "高利币", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Stupid-Ass Ape", "蠢蛋猿猴", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "UNSAFE.DAT", "危险.DAT", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bug", "漏洞", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Virus Scanner", "病毒扫描器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Curve Hopper Hopper", "跑赢曲线跑赢器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Training Dummy", "训练假人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Vessel", "血能容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spring Vessel", "弹簧容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Conduit Vessel", "管道容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dredging Vessel", "挖泥容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Vessel", "涡轮容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Sapphire Vessel", "涡轮蓝宝石容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Ruby Vessel", "涡轮红宝石容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Emerald Vessel", "涡轮绿宝石容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Blood Vessel", "涡轮血能容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Spring Vessel", "涡轮弹簧容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Conduit Vessel", "涡轮管道容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo Dredging Vessel", "涡轮挖泥容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "L33pb0t", "跳跃机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Turbo L33pb0t", "涡轮跳跃机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tree", "树", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mole Man", "鼹鼠人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "MAGBRUSH.EXE", "蔓尼画笔.exe", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "GRIMQUIL.EXE", "格里羽笔.exe", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Firewall", "防火墙", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Replicating Firewall", "复制体防火墙", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hunter Brain", "赏金猎人脑", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Activated Hunter", "激活的赏金猎人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "yarr.torrent", "海盗湾.torrent", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "R!V3R 5N4PP3R", "机械鳄龟", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "M013", "机械鼹鼠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "R488!7", "机械兔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "M4N7!5", "机械螳螂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "41PH4", "机械头狼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Robopossum", "机械负鼠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Grandpa:Clock", "时钟:爷爷", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ghoulware", "鬼灵软件", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mox Obelisk", "宝石方尖碑", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Conduit Tower", "管道塔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Radio Tower", "信号塔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Generator", "发电机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Power Sink", "能量塔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Failed Experiment", "失败实验品", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heal Conduit", "治疗管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Experiment #1", "实验体1号", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skeleton Master", "骷髅大师", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Double Death", "双重死亡", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Head Shot", "爆头射击", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[creature] is immune to the effects of Touch of Death, Stinky, and fire.", "[creature]可免疫死神之触、臭臭印记和火焰的效果", Language.ChineseSimplified);
            // Card: ExpansionPack1
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "B30WULF", "机械人狼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "PYTH0N", "机械蟒蛇", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Asmanteus", "机械拟螳螂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "SeedBot", "种子机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Conveyor Latcher", "传带传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sky Latcher", "天空传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "W0rm", "机械蠕虫", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fishbones", "鱼骨", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Koi", "锦鲤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Salmon", "鲑鱼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "B3A5T GR4ND M4ST3R", "机械兽群大师", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "B3A5T M4ST3R", "机械野兽大师", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "T4URU5", "机械公牛", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "SearchBot", "搜索机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "AmmoBot", "弹药机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oil Jerry", "油罐杰瑞", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Necronomaton", "死灵机甲", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Zombie Process", "僵尸进程", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "AngelBot", "天使机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Conduit Protector", "管道守卫", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skel-E-Cell", "骷髅电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Airspace Conduit", "空域管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Foul Conduit", "污秽管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spyplane", "侦察机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Executor", "执行器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Copypasta", "复制粘贴", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "FrankenCell", "弗兰肯电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mr:Clock", "时钟:先生", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Roboducky", "机械小鸭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ruby Titan", "红宝石泰坦", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sapphire Titan", "蓝宝石泰坦", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emerald Titan", "绿宝石泰坦", Language.ChineseSimplified);
            // Card: ExpansionPack2
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Swapper Latcher", "交换传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Box Bot", "箱型机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "ScrapBot", "废料机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Scrap Bot", "废料机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Zip Bomb", "压缩炸弹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "R4M", "机械公羊", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Elektron", "电子机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Billdozer", "推土机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Librarian", "图书管理员", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ruby Sentinel", "红宝石哨兵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emerald Sentinel", "绿宝石哨兵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sapphire Sentinel", "蓝宝石哨兵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ignitron", "打火机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "GlowBot", "辉光机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "M0l0t0v", "机械燃油弹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gas Conduit", "气体管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Street Sweeper", "街道清扫者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shield Smuggler", "护盾走私者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pity Seeker", "怜悯搜寻者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Urch1n Conduit", "机械海胆管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rh1n0", "机械犀牛", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "3leph4nt", "机械巨象", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Jimmy Jr.", "小吉米", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "OP Bot", "管理员机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Weeper", "哭泣者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sui-Cell", "自毁电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bedazzling Conduit", "炫彩管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "G0ph3r", "机械地鼠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "P00dl3", "机械贵宾犬", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Flamecharmer", "火焰驯服者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Artillery Droid", "火炮机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ultra Bot", "究极机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hellfire Commando", "地狱火突击兵", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Energy Vampire", "能量吸血鬼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Orange Juicer", "橙汁榨取机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dr Zambot", "赞博特博士", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Chippy", "碎碎", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "L33pB0t Neo", "跳跃机器人尼奥", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Encapsulator", "封装机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sir Blast", "爆破爵士", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tapeworm", "机械绦虫", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Lockjaw Cell", "锁颚电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Replica Bleene", "蓝绿橙复制体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Replica Orlu", "橙蓝绿复制体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Replica Goranj", "绿橙蓝复制体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gem Auger", "宝石钻机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sparkplug Cell", "火花塞电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Splice Conduit", "拼接管道", Language.ChineseSimplified);
            // Card: Multiverse
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "M013", "机械鼹鼠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Firewall", "防火墙", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "49er", "黄金矿工", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sentry Drone", "哨兵无人机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bolthound", "螺栓铁狗", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Explode Bot", "自爆机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Null Conduit", "空无管道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Multi Gunner", "多枪手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mox Module", "玛珂模块", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bomb Latcher", "炸弹传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shield Latcher", "坚盾传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skel-E-Latcher", "骷髅传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "L33pBot", "跳跃机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oil Jerry", "油罐杰瑞", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "AmmoBot", "弹药机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "DummyCard", "哑卡牌", Language.ChineseSimplified);
    ...
    public class P03ExpansionPack3Mod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for P03ExpansionPack3 Mod");
            // Card
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Unpacker", "解包器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gunbot", "枪械机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "KR4K3N", "机械克拉肯", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Brain Cell", "脑电池", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Muscle Droid", "肌肉机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "D.A.N.N.Y.", "丹.尼.", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Butane Caster", "丁烷铸造机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Automatomaton", "自动动机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Automatomatomaton", "自动动动机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Demoted Automatomaton", "降级自动动机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Robipper", "机器人收割者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "GameKid", "游戏小子", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Green Energy Bot", "绿色能源机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Molotov Launcher", "燃油弹发射器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Tow Truck", "拖车机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Nitrous Tanker", "氮气罐车", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Mill", "骨粉研磨机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "B4D A55", "机械混蛋", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mucus Launcher", "黏液发射器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "General Gunk", "黏液将军", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gachabomb", "扭蛋炸弹", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Submariner", "潜水员", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Rot Latcher", "腐化传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Time Latcher", "时间传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Catapult", "投石机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cat-A-Pult", "喵式投石机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Synthesioid", "合成体", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Remote Detonator", "远程引爆器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Scavenger", "拾荒者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Corpse Looter", "尸体掠夺者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Looter Shooter", "掠夺射手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Super Looter Shooter", "超级掠夺射手", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Skin Droid", "皮肤机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emergence Latcher", "潜伏传递者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cottagecog", "小屋齿轮", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Baristabot", "咖啡师机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mystery Machine", "神秘机器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sticker King", "贴纸之王", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Booger Barrel", "鼻涕桶", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Artificer", "巧匠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gear Shifter", "齿轮变速器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shrinker", "缩小机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Time Machine", "时光机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Open Sorcerer", "开放术士", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Kiln", "熔炉", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Shield Projector", "护盾投射器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Blood Vessel", "血能容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dredger Vessel", "挖泥容器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fuel Attendant", "燃料管理员", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hot Rod", "飞车党", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bone Cracker", "碎骨者", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hivemind", "蜂群意识", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ramshackle", "破铜烂铁", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "N-GINN", "引擎机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Iterator", "迭代器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Gas Generator", "气体生成器", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Crypton", "加密战机", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "UFO", "UFO", Language.ChineseSimplified);
    ...
    public class PeltsOnlyMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for PeltsOnly Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Pelts Only", "只有毛皮", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "All Card Choices are replaced with either Trapper or Trader.", "所有卡牌选择节点都将替换为猎人和毛皮商。", Language.ChineseSimplified);
    ...
    public class DeathcardChallengesMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for DeathcardChallenges Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deathcards", "死亡卡", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You may find past challengers' deathcards during your run", "你可以在冒险过程中找到过去挑战者的死亡卡。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deathcard Creation", "死亡卡创建", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You will create a deathcard if you lose", "如果你在这场冒险中失败了，你可以创建一张死亡卡。", Language.ChineseSimplified);
    ...
    public class PermaDeathMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for PermaDeath Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Perma Death on die", "永久战败之死", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "All card are removed from your deck if killed.", "如果你卡组中的任意卡牌在战斗中被杀死，其将从你的牌组中被永久移除（即便有不死之虫也是如此）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Perma Death on sacrifice", "永久献祭之死", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "All card are removed from your deck if sacrificed.", "如果你卡组中的任意卡牌被你献祭过，其将从你的牌组中被永久移除（即便有生生不息也是如此）。", Language.ChineseSimplified);
    ...
    public class KCMHammerMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for KCMHammer Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hammer", "锤子", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You may use the hammer to destroy your own cards", "你可以使用锤子销毁自己的卡牌。", Language.ChineseSimplified);
    ...
    public class BetterTotemsMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for BetterTotems Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Better Totems", "更好的图腾", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The Woodcarver will no longer give you totems with weak sigils", "木雕师不会再给你低强度等级印记的图腾。", Language.ChineseSimplified);
    ...
    public class EyeAndDaggerMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for EyeAndDagger Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dagger", "特制匕首", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Grants the player a starting dagger instead of a pair of pliers", "开局使玩家拥有匕首而不是钳子（注意与KCMLoadouts模组同时使用时可能引发问题）。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Goat Eye", "山羊眼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Grants the goat eye effect.", "授予山羊眼效果。", Language.ChineseSimplified);
    ...
    public class LesserSideDeckMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for LesserSideDeck Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Smaller Side Deck", "更少的副牌", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Remove 2 cards from your side deck.", "你的副牌组的牌减少2张。", Language.ChineseSimplified);

        }
    }
    public class CursesMod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for Curses Mod");
            // Ability/Card
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bitten By Predator", "被掠食者咬伤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This card was bitten by a predator", "这张牌被掠食者咬伤。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bow and Arrow", "弓与箭", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Capture", "捕获", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Spike Trap", "尖刺陷阱", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Mega Shark", "大鲨鱼", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Swallow Whole", "囫囵吞", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dynamite!?", "炸药！？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Booby Trap", "诱杀装置", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "If this is in your hand at the end of your turn, it explodes. If it is on the board at the end of your opponent's turn, it explodes. Either way, it explodes.", "如果此牌在你回合结束时在你手中，它会爆炸。如果它在你对手的回合结束时在场地上，它会爆炸。不管怎样，它都会爆炸。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This is more difficult than anticipated...", "这比预期的要困难得多...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "We - We may have made things worse", "我们可能让事情变得更糟了...", Language.ChineseSimplified);

            // Achievement
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Cursed Achievements", "被诅咒的成就", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Here For A Good Time", "玩得开心", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Complete a run with a negative challenge level", "以负挑战点数完成冒险。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Here For A Hard Time", "艰难时光", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Complete a run with a challenge level above 250", "完成挑战点数高于250的冒险。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Utter Insanity", "彻底疯狂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Complete a run with two Chaotic Enemy skulls active", "在激活两个混乱的敌人挑战的情况下完成冒险。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Too Spooky", "太恐怖了", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Reach the maximum deathcard haunt level", "达到死亡卡鬼魂级别上限。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That's No Moon", "那不是月亮", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Defeat the Limoncello with the Bigger Moon skull active", "开启满月挑战并击败柠檬琴号。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "'Tis But A Flesh Wound", "不过皮肉伤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Retrieve a damaged card from the belly of a Mega Shark", "从大鲨鱼口中取回一张损坏的卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Munitions Expert", "弹药专家", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Safely dispose of a stick of dynamite", "安全地处理炸药。", Language.ChineseSimplified);


            // Challenge
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Full Moon", "满月", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Giant cards like the moon have more attack and health", "类似月亮的巨人卡有更多的攻击力和生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Minor Boon of the Bone Lord", "骨王之惠", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Start the game with a Minor Boon of the Bone Lord", "在拥有骨王之惠的情况下开始游戏。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Checking to see if we should add a deathcard...", "检查是否应该添加死亡卡...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Haunted Past", "阴魂不散的过去", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Deathcards will sometimes attack you in battle", "死亡卡有时会在敌对战斗中出现。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Exploding Cards", "爆炸卡牌", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dynamite is added to your deck after every boss battle", "每次头目战斗，炸药都会添加到你的场地上。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Golden Beginnings", "黄金起始", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Start the game with the ability to draft a rare card", "开始游戏时，可以抽取一张稀有卡牌。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Boss Revenge", "头目复仇战", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Each boss has an additional phase", "每个头目都有一个额外阶段。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Two Turn Minimum", "至少二回合", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You cannot deal lethal damage on the first turn.", "你不能在第一回合造成致命伤害。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Chaotic Enemies", "混乱的敌人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Opposing creatures gain random abilities", "敌方造物获得随机印记。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Totem Collector", "图腾收藏家", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You start with all tribal totem tops", "你开局获得所有部落的图腾头部。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Extra Candle", "额外蜡烛", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You are given an extra life", "你被赋予了额外的生命。", Language.ChineseSimplified);

            // DialogueEvent
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you feel a chill in the air", "你感到空气中弥漫着寒意", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the hair stands up on the back of your neck", "你后颈的汗毛竖了起来", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:bR][v:0][c:] has arrived", "[c:bR][v:0][c:]已降临", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you suddenly feel weak", "你突然感到虚弱", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "your teeth start to chatter", "你的牙齿开始打颤", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:bR][v:0][c:] is coming", "[c:bR][v:0][c:]正在逼近", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you can't explain how", "你无法解释缘由", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "but you can feel the presence of [c:bR][v:0][c:]", "但你能感受到[c:bR][v:0][c:]的存在", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "it finally happened: [c:bR][v:0][c:] is here", "终于来了：[c:bR][v:0][c:]现身了", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:O]\"I have been looking for you\"[c:] says the apparition", "[c:O]“我一直在找你”[c:]幽灵低语道", Language.ChineseSimplified) ;
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:O]\"And now you must die!\"[c:]", "[c:O]“现在你该死了！”[c:]", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the apparition has nothing to say", "幽灵沉默不语", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "but you sense that it is here for you", "但你知道它是冲你而来", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:O]\"you made a mistake coming here\"[c:] it growls", "[c:O]“你来错地方了”[c:]它低吼道", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:O]\"let me show you the way home\"[c:]", "[c:O]“让我带你回家”[c:]", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the apparition seems lonely", "幽灵显得孤寂", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "it wants you to join it in the afterlife", "它想让你在死后世界陪伴它", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the apparition fades into the wind", "幽灵随风消散", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you can't shake the feeling there are [c:O]more[c:] out there waiting", "你总觉得还有[c:O]更多[c:]在暗处等待", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "[c:bR][v:0][c:] shivers with delight as your candle is extinguished", "[c:bR][v:0][c:]因你的烛火熄灭而欢愉战栗", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "do you see the [c:O]appar[c:][c:] encircling you?", "看见环绕你的[c:O]幽灵[c:]了吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "you have become [c:O]haunted[c:] by [c:O]those who have come before[c:]", "你已被[c:O]逝去[c:]的[c:O]怨念[c:]缠身", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "the more you [c:O]win in battle[c:] the angrier they become", "你[c:O]战斗胜利[c:]次数越多，它们怨气越重", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "and they may [c:O]oppose you in battle[c:] in the future", "未来它们可能[c:O]在战斗中与你[c:]对立", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Let's play longer this time!", "这次咱们多玩会儿！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A lil' more fun never hurt nobody!", "多乐呵乐呵总没坏处！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I got a little somethin' special for ya!", "老子给你备了点儿好货！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heeeeeeee-haaw! Let's keep the fun goin'!", "嘿——哈！接着乐呵！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You want more fish?", "还想要鱼？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "We get extra fish.", "这次鱼多。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Many fish this time.", "鱼管够。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I'm afraid our encounter today will take a little more time", "恐怕今日你我相遇要多费些时辰", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "It looks like you and I have extra business to attend to", "看来你我还有些额外买卖要谈", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "He swalled it whole..", "它囫囵吞下去了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Eating that was a bad idea..", "吃这玩意儿可不明智……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That's a little uncomfortable..", "这吃着有点硌得慌……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your [c:bR][v:0][c:] has been fully digested. You will never see it again.", "你的[c:bR][v:0][c:]已被完全消化。你再也见不到它了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Your [c:bR][v:0][c:] is being slowly digested. It has [c:bR][v:1][c:] health left.", "你的[c:bR][c:bR][v:0][c:]正在被缓慢消化。还剩[c:bR][v:1][c:]点生命值。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I have yet another trade to propose", "老夫还有桩买卖要谈", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "This time, let us trade our whole decks", "这回咱们来换一整副牌组", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "He's hungry again", "它又饿了", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Time for more morsels", "该喂食了", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Back on the hunt", "继续猎食", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Think fast!", "接稳了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Catch!", "接着！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Heads up!", "看招！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You're a dad-gum pain in my backside!", "你他娘的是老子裤裆里的刺儿！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Let's see you get past this!", "看你怎么过这关！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fish not big enough. Get bigger fish.", "鱼不够大。搞更大的。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Little fish bad. Big fish better.", "小鱼不行。大鱼得劲。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Need better fish.", "要更好鱼。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "That fella looks mighty curious about that [c:bR]empty lane[c:]", "那崽子对[c:bR]空路线[c:]可馋得很", Language.ChineseSimplified);
    ...
    public class EndlessAct2Mod
    {
        public static void RegisterTranslations()
        {
            Debug.Log("Registering Tanslations for EndlessAct2 Mod");
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "SELECT A DECK TO USE.\nTHIS WILL OVERRIDE YOUR CURRENT DECK!", "选择要使用的牌组。\n这将覆盖你当前的牌组！", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You have only one boon slot.", "你只能装备一张奖励卡牌。", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Select the Deck of Beasts?", "选择野兽牌组？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Select the Deck of the Dead?", "选择死亡牌组？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Select the Deck of Technology?", "选择科技牌组？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Select the Deck of Magick?", "选择魔法牌组？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Take the deck.", "拿起你的牌组。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Leave it.", "离开这里。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You need at least 20 cards in your deck!", "你的牌组至少需要20张牌！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "No offering in your deck?", "你的牌组中没有祭品？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fine. Take this instead.", "好吧，拿这个代替。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "What? You still crave more?", "什么？你还想要更多吗？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fine. Take this.", "好吧，拿上这个。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Reincarnation", "转世轮回", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Voltage", "电压", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Construct", "构筑", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Fossil", "化石", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "BountyHunter", "赏金猎人", Language.ChineseSimplified);
            ...
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Conduit Tower", "管道塔", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Broken Bot", "破碎机器人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bridge Railing", "桥梁栏杆", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Emerald Boulder", "绿宝磐石", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Ruby Boulder", "红宝磐石", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Sapphire Boulder", "蓝宝磐石", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Bounty Hunter", "赏金猎人", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Waddup, to all rappers shut up with your shutting up.", "哇哦，让所有的说唱歌手闭嘴。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "My injuries.. They are severe.", "我的伤……它们很严重。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I am forced to retire.. for now.", "看来我要在这里……提前退休了。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Argh!! What have you done to me?", "啊！！你对我做了什么？", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Everything hurts... But.. I'll be back..", "一切都让我感到痛苦……但……我会回来的...", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Well.. you stopped me..", "嗯...你阻止了我……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I WILL get you.. challenger..", "我会抓住你……挑战者……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I've been scrapped!", "我被杀了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "You beat me fair and square...", "你完全击败了我……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "So I will retreat.. well played.. Expect a rematch soon though..", "所以我要先撤退了……打得不错……期待不久之后的再战。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "So, we meet again..", "所以，我们又见面了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Oh.. Its You..", "哦，是你。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Aha! Found you!", "啊哈，找到你了！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "I've come to get my revenge!", "我是来报仇的！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Surprise!", "惊喜吧！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Hey.", "喂。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Well, Hello there.", "好的，欢迎来到这里。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Greeetings!", "向你问候！", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Just what do YOU think you're doing? Wandering around and destroying our dungeons.", "你以为你在干什么？四处游荡，摧毁我们的地牢。", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "A little mouse wanders into my sight..", "一只小老鼠闯入我的视线……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "At last, I have found you..", "我终于找到你了……", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Beasts", "野兽", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Technology", "科技", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Magick", "魔法", Language.ChineseSimplified);
            LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Dead", "死亡", Language.ChineseSimplified);
            ...
            foreach (var n in bountyName)
            {
                foreach (var s in bountySuffix)
                {
                    ...
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "The one who destroyed " + name + "... You won't get away with it again.", "那个毁掉" + namechinese + "的家伙……这次你别想逃", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Didn't expect to see " + name + " again, did ya?", "没想到会再见到" + namechinese + "吧？", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Unfortunately, " + name + " is back.", "真不幸，" + namechinese + "回来了。", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "They call me.. " + name + ".. You can't defeat ME!", "他们叫我" + namechinese + "……你赢不了我的！", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Let's see you stop " + name + ".", "看你怎么阻止" + namechinese + "。", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, "Just remember that " + name + " can not be defeated.", "记住，" + namechinese + "是不可战胜的。", Language.ChineseSimplified);
                    LocalizationManager.Translate(SimplifiedChineseLanguagePackPlugin.GUID, null, name + " will be your executioner for the evening.", namechinese + "将成为你今晚的处刑人", Language.ChineseSimplified);
